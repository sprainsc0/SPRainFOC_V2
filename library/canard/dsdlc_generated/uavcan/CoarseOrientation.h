 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\CoarseOrientation.uavcan
 */
...
static inline
int32_t uavcan_CoarseOrientation_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_CoarseOrientation* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_CoarseOrientation_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_CoarseOrientation* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_CoarseOrientation_encode(uavcan_CoarseOrientation* source, void* msg_buf)
{
    ...
    offset = uavcan_CoarseOrientation_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_CoarseOrientation_decode(const CanardTransfer* transfer,
