 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\2.GetDataTypeInfo.uavcan
 */
...
static inline
int32_t uavcan_protocol_GetDataTypeInfoRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetDataTypeInfoRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_GetDataTypeInfoRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetDataTypeInfoRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_GetDataTypeInfoResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetDataTypeInfoResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_GetDataTypeInfoResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetDataTypeInfoResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_GetDataTypeInfoRequest_encode(uavcan_protocol_GetDataTypeInfoRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_GetDataTypeInfoRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_GetDataTypeInfoRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_GetDataTypeInfoResponse_encode(uavcan_protocol_GetDataTypeInfoResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_GetDataTypeInfoResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_GetDataTypeInfoResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_GetDataTypeInfoResponse* dest,
  uint8_t** dyn_arr_buf)
{
