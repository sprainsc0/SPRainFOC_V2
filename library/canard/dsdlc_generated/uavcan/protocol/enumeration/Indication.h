 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\enumeration\380.Indication.uavcan
 */
...
static inline
int32_t uavcan_protocol_enumeration_Indication_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_enumeration_Indication* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_enumeration_Indication_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_enumeration_Indication* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_enumeration_Indication_encode(uavcan_protocol_enumeration_Indication* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_enumeration_Indication_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_enumeration_Indication_decode(const CanardTransfer* transfer,
