 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\param\10.ExecuteOpcode.uavcan
 */
...
static inline
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_ExecuteOpcodeRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_ExecuteOpcodeRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_ExecuteOpcodeResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_ExecuteOpcodeResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_param_ExecuteOpcodeRequest_encode(uavcan_protocol_param_ExecuteOpcodeRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_param_ExecuteOpcodeRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_param_ExecuteOpcodeResponse_encode(uavcan_protocol_param_ExecuteOpcodeResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_param_ExecuteOpcodeResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_param_ExecuteOpcodeResponse* dest,
  uint8_t** dyn_arr_buf)
{
