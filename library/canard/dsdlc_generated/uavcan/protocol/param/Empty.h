 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\param\Empty.uavcan
 */
...
static inline
int32_t uavcan_protocol_param_Empty_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_Empty* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_param_Empty_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_param_Empty* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
int32_t uavcan_protocol_param_Empty_decode_internal(const CanardTransfer* CANARD_MAYBE_UNUSED(transfer),
...
int32_t uavcan_protocol_param_Empty_decode(const CanardTransfer* CANARD_MAYBE_UNUSED(transfer),
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  uavcan_protocol_param_Empty* CANARD_MAYBE_UNUSED(dest),
  uint8_t** CANARD_MAYBE_UNUSED(dyn_arr_buf))
{
