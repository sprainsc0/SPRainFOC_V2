 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\4.GetTransportStats.uavcan
 */
...
static inline
int32_t uavcan_protocol_GetTransportStatsRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetTransportStatsRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_GetTransportStatsRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetTransportStatsRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_GetTransportStatsResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetTransportStatsResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_GetTransportStatsResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_GetTransportStatsResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
int32_t uavcan_protocol_GetTransportStatsRequest_decode_internal(const CanardTransfer* CANARD_MAYBE_UNUSED(transfer),
...
int32_t uavcan_protocol_GetTransportStatsRequest_decode(const CanardTransfer* CANARD_MAYBE_UNUSED(transfer),
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  uavcan_protocol_GetTransportStatsRequest* CANARD_MAYBE_UNUSED(dest),
  uint8_t** CANARD_MAYBE_UNUSED(dyn_arr_buf))
{
...
uint32_t uavcan_protocol_GetTransportStatsResponse_encode(uavcan_protocol_GetTransportStatsResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_GetTransportStatsResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_GetTransportStatsResponse_decode(const CanardTransfer* transfer,
