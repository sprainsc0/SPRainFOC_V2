 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\file\49.Write.uavcan
 */
...
static inline
int32_t uavcan_protocol_file_WriteRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_WriteRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_WriteRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_WriteRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_file_WriteResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_WriteResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_WriteResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_WriteResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_file_WriteRequest_encode(uavcan_protocol_file_WriteRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_WriteRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_WriteRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_file_WriteResponse_encode(uavcan_protocol_file_WriteResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_WriteResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_WriteResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_file_WriteResponse* dest,
  uint8_t** dyn_arr_buf)
{
