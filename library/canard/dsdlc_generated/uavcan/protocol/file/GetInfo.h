 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\file\45.GetInfo.uavcan
 */
...
static inline
int32_t uavcan_protocol_file_GetInfoRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_GetInfoRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_GetInfoRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_GetInfoRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_file_GetInfoResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_GetInfoResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_GetInfoResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_GetInfoResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_file_GetInfoRequest_encode(uavcan_protocol_file_GetInfoRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_GetInfoRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_GetInfoRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_file_GetInfoResponse_encode(uavcan_protocol_file_GetInfoResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_GetInfoResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_GetInfoResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_file_GetInfoResponse* dest,
  uint8_t** dyn_arr_buf)
{
