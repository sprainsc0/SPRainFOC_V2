 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\file\40.BeginFirmwareUpdate.uavcan
 */
...
static inline
int32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_BeginFirmwareUpdateRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_BeginFirmwareUpdateRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_BeginFirmwareUpdateResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_file_BeginFirmwareUpdateResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_encode(uavcan_protocol_file_BeginFirmwareUpdateRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_BeginFirmwareUpdateRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_encode(uavcan_protocol_file_BeginFirmwareUpdateResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_file_BeginFirmwareUpdateResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_file_BeginFirmwareUpdateResponse* dest,
  uint8_t** dyn_arr_buf)
{
