 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\protocol\6.AccessCommandShell.uavcan
 */
...
static inline
int32_t uavcan_protocol_AccessCommandShellRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_AccessCommandShellRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_protocol_AccessCommandShellResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_protocol_AccessCommandShellResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_protocol_AccessCommandShellResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_protocol_AccessCommandShellRequest_encode(uavcan_protocol_AccessCommandShellRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_AccessCommandShellRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_AccessCommandShellRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_protocol_AccessCommandShellResponse_encode(uavcan_protocol_AccessCommandShellResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_protocol_AccessCommandShellResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_protocol_AccessCommandShellResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_protocol_AccessCommandShellResponse* dest,
  uint8_t** dyn_arr_buf)
{
