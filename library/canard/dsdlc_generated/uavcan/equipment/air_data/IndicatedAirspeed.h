 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\equipment\air_data\1021.IndicatedAirspeed.uavcan
 */
...
static inline
int32_t uavcan_equipment_air_data_IndicatedAirspeed_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_equipment_air_data_IndicatedAirspeed* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_equipment_air_data_IndicatedAirspeed_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_equipment_air_data_IndicatedAirspeed* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_equipment_air_data_IndicatedAirspeed_encode(uavcan_equipment_air_data_IndicatedAirspeed* source, void* msg_buf)
{
    ...
    offset = uavcan_equipment_air_data_IndicatedAirspeed_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_equipment_air_data_IndicatedAirspeed_decode(const CanardTransfer* transfer,
