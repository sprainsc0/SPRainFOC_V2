 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\equipment\actuator\1011.Status.uavcan
 */
...
static inline
int32_t uavcan_equipment_actuator_Status_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_equipment_actuator_Status* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_equipment_actuator_Status_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_equipment_actuator_Status* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_equipment_actuator_Status_encode(uavcan_equipment_actuator_Status* source, void* msg_buf)
{
    ...
    offset = uavcan_equipment_actuator_Status_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_equipment_actuator_Status_decode(const CanardTransfer* transfer,
