 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\tunnel\Protocol.uavcan
 */
...
static inline
int32_t uavcan_tunnel_Protocol_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_Protocol* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_tunnel_Protocol_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_Protocol* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_tunnel_Protocol_encode(uavcan_tunnel_Protocol* source, void* msg_buf)
{
    ...
    offset = uavcan_tunnel_Protocol_encode_internal(source, msg_buf, offset, 0);
  ...
  int32_t offset)
{
    ...
    ret = canardDecodeScalar(transfer, offset, 8, false, (void*)&dest->protocol);
    if (ret != 8)
    {
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_tunnel_Protocol_decode(const CanardTransfer* transfer,
