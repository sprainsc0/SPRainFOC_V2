 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\tunnel\2010.Broadcast.uavcan
 */
...
static inline
int32_t uavcan_tunnel_Broadcast_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_Broadcast* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_tunnel_Broadcast_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_Broadcast* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_tunnel_Broadcast_encode(uavcan_tunnel_Broadcast* source, void* msg_buf)
{
    ...
    offset = uavcan_tunnel_Broadcast_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_tunnel_Broadcast_decode(const CanardTransfer* transfer,
