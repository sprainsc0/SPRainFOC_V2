 ...
 *
 * Source file: i:\BlackBox\aircraft_h7\module\canard\dsdl\uavcan\tunnel\63.Call.uavcan
 */
...
static inline
int32_t uavcan_tunnel_CallRequest_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallRequest* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_tunnel_CallRequest_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallRequest* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
static inline
int32_t uavcan_tunnel_CallResponse_decode(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallResponse* dest, uint8_t** dyn_arr_buf);
...
static inline
int32_t uavcan_tunnel_CallResponse_decode_internal(const CanardTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
...
uint32_t uavcan_tunnel_CallRequest_encode(uavcan_tunnel_CallRequest* source, void* msg_buf)
{
    ...
    offset = uavcan_tunnel_CallRequest_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_tunnel_CallRequest_decode(const CanardTransfer* transfer,
...
uint32_t uavcan_tunnel_CallResponse_encode(uavcan_tunnel_CallResponse* source, void* msg_buf)
{
    ...
    offset = uavcan_tunnel_CallResponse_encode_internal(source, msg_buf, offset, 0);
...
/**
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t uavcan_tunnel_CallResponse_decode(const CanardTransfer* transfer,
  uint16_t payload_len,
  uavcan_tunnel_CallResponse* dest,
  uint8_t** dyn_arr_buf)
{
