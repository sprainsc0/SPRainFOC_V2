...
struct bgc_parameters_t {
    ...
    const struct param_info_s __param__DIRECT_INVERT;
    ...
    const struct param_info_s __param__LHALL_U;  
    const struct param_info_s __param__LHALL_LAMDA;
    const struct param_info_s __param__LHALL_BETA;
    const struct param_info_s __param__LHALL_MIDA;  
    const struct param_info_s __param__LHALL_MIDB;
    const struct param_info_s __param__LHALL_MIDC;
