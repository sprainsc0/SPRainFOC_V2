...
const struct bgc_parameters_t foc_parameters = {
    ...
    {"MOTOR_R",       PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.608f },    // Ohm
    {"MOTOR_L",       PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 4.63e-4f },  // H
    {"MOTOR_L_DIFF",  PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.0f },
    {"FLUX_LINKAGE",  PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.0f },
    {"DIRECT_INVERT", PARAM_TYPE_INT32, .volatile_param = 0,.val.i = 0 },
    ...
    {"LHALL_U",       PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.4f },
    {"LHALL_LAMDA",   PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.0f },
    {"LHALL_BETA",    PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 0.0f },
    {"LHALL_MIDA",    PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 1.0f },
    {"LHALL_MIDB",    PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 1.0f },
    {"LHALL_MIDC",    PARAM_TYPE_FLOAT, .volatile_param = 0,.val.f = 1.0f },
