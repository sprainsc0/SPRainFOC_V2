...
{
    return mavlink_msg_highres_imu_pack(system_id, component_id, msg, (uint64_t )(highres_imu->time_usec), (float )(highres_imu->xacc), (float )(highres_imu->yacc), (float )(highres_imu->zacc), (float )(highres_imu->xgyro), (float )(highres_imu->ygyro), (float )(highres_imu->zgyro), (float )(highres_imu->xmag), (float )(highres_imu->ymag), (float )(highres_imu->zmag), (float )(highres_imu->abs_pressure), (float )(highres_imu->diff_pressure), (float )(highres_imu->pressure_alt), (float )(highres_imu->temperature), (uint16_t )(highres_imu->fields_updated), (uint8_t )(highres_imu->id));
}
...
{
    return mavlink_msg_highres_imu_pack_chan(system_id, component_id, chan, msg, (uint64_t )(highres_imu->time_usec), (float )(highres_imu->xacc), (float )(highres_imu->yacc), (float )(highres_imu->zacc), (float )(highres_imu->xgyro), (float )(highres_imu->ygyro), (float )(highres_imu->zgyro), (float )(highres_imu->xmag), (float )(highres_imu->ymag), (float )(highres_imu->zmag), (float )(highres_imu->abs_pressure), (float )(highres_imu->diff_pressure), (float )(highres_imu->pressure_alt), (float )(highres_imu->temperature), (uint16_t )(highres_imu->fields_updated), (uint8_t )(highres_imu->id));
}
