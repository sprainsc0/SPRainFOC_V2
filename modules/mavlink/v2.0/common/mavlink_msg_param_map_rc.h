...
{
    return mavlink_msg_param_map_rc_pack(system_id, component_id, msg, (uint8_t )(param_map_rc->target_system), (uint8_t )(param_map_rc->target_component), (const char *)(param_map_rc->param_id), (int16_t )(param_map_rc->param_index), (uint8_t )(param_map_rc->parameter_rc_channel_index), (float )(param_map_rc->param_value0), (float )(param_map_rc->scale), (float )(param_map_rc->param_value_min), (float )(param_map_rc->param_value_max));
}
...
{
    return mavlink_msg_param_map_rc_pack_chan(system_id, component_id, chan, msg, (uint8_t )(param_map_rc->target_system), (uint8_t )(param_map_rc->target_component), (const char *)(param_map_rc->param_id), (int16_t )(param_map_rc->param_index), (uint8_t )(param_map_rc->parameter_rc_channel_index), (float )(param_map_rc->param_value0), (float )(param_map_rc->scale), (float )(param_map_rc->param_value_min), (float )(param_map_rc->param_value_max));
}
