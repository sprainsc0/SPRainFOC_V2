...
{
    return mavlink_msg_logging_ack_pack(system_id, component_id, msg, (uint8_t )(logging_ack->target_system), (uint8_t )(logging_ack->target_component), (uint16_t )(logging_ack->sequence));
}
...
{
    return mavlink_msg_logging_ack_pack_chan(system_id, component_id, chan, msg, (uint8_t )(logging_ack->target_system), (uint8_t )(logging_ack->target_component), (uint16_t )(logging_ack->sequence));
}
