...
{
    return mavlink_msg_mission_count_pack(system_id, component_id, msg, (uint8_t )(mission_count->target_system), (uint8_t )(mission_count->target_component), (uint16_t )(mission_count->count), (uint8_t )(mission_count->mission_type));
}
...
{
    return mavlink_msg_mission_count_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_count->target_system), (uint8_t )(mission_count->target_component), (uint16_t )(mission_count->count), (uint8_t )(mission_count->mission_type));
}
