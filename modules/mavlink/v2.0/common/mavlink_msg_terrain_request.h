...
{
    return mavlink_msg_terrain_request_pack(system_id, component_id, msg, (int32_t )(terrain_request->lat), (int32_t )(terrain_request->lon), (uint16_t )(terrain_request->grid_spacing), (uint64_t )(terrain_request->mask));
}
...
{
    return mavlink_msg_terrain_request_pack_chan(system_id, component_id, chan, msg, (int32_t )(terrain_request->lat), (int32_t )(terrain_request->lon), (uint16_t )(terrain_request->grid_spacing), (uint64_t )(terrain_request->mask));
}
