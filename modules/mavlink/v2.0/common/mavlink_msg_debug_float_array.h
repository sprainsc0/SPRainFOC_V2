...
{
    return mavlink_msg_debug_float_array_pack(system_id, component_id, msg, (uint64_t )(debug_float_array->time_usec), (const char *)(debug_float_array->name), (uint16_t )(debug_float_array->array_id), (const float *)(debug_float_array->data));
}
...
{
    return mavlink_msg_debug_float_array_pack_chan(system_id, component_id, chan, msg, (uint64_t )(debug_float_array->time_usec), (const char *)(debug_float_array->name), (uint16_t )(debug_float_array->array_id), (const float *)(debug_float_array->data));
}
