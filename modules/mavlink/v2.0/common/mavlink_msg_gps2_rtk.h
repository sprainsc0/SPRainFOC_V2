...
{
    return mavlink_msg_gps2_rtk_pack(system_id, component_id, msg, (uint32_t )(gps2_rtk->time_last_baseline_ms), (uint8_t )(gps2_rtk->rtk_receiver_id), (uint16_t )(gps2_rtk->wn), (uint32_t )(gps2_rtk->tow), (uint8_t )(gps2_rtk->rtk_health), (uint8_t )(gps2_rtk->rtk_rate), (uint8_t )(gps2_rtk->nsats), (uint8_t )(gps2_rtk->baseline_coords_type), (int32_t )(gps2_rtk->baseline_a_mm), (int32_t )(gps2_rtk->baseline_b_mm), (int32_t )(gps2_rtk->baseline_c_mm), (uint32_t )(gps2_rtk->accuracy), (int32_t )(gps2_rtk->iar_num_hypotheses));
}
...
{
    return mavlink_msg_gps2_rtk_pack_chan(system_id, component_id, chan, msg, (uint32_t )(gps2_rtk->time_last_baseline_ms), (uint8_t )(gps2_rtk->rtk_receiver_id), (uint16_t )(gps2_rtk->wn), (uint32_t )(gps2_rtk->tow), (uint8_t )(gps2_rtk->rtk_health), (uint8_t )(gps2_rtk->rtk_rate), (uint8_t )(gps2_rtk->nsats), (uint8_t )(gps2_rtk->baseline_coords_type), (int32_t )(gps2_rtk->baseline_a_mm), (int32_t )(gps2_rtk->baseline_b_mm), (int32_t )(gps2_rtk->baseline_c_mm), (uint32_t )(gps2_rtk->accuracy), (int32_t )(gps2_rtk->iar_num_hypotheses));
}
