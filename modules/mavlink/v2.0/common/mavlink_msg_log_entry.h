...
{
    return mavlink_msg_log_entry_pack(system_id, component_id, msg, (uint16_t )(log_entry->id), (uint16_t )(log_entry->num_logs), (uint16_t )(log_entry->last_log_num), (uint32_t )(log_entry->time_utc), (uint32_t )(log_entry->size));
}
...
{
    return mavlink_msg_log_entry_pack_chan(system_id, component_id, chan, msg, (uint16_t )(log_entry->id), (uint16_t )(log_entry->num_logs), (uint16_t )(log_entry->last_log_num), (uint32_t )(log_entry->time_utc), (uint32_t )(log_entry->size));
}
