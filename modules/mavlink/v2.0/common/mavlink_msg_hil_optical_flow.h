...
{
    return mavlink_msg_hil_optical_flow_pack(system_id, component_id, msg, (uint64_t )(hil_optical_flow->time_usec), (uint8_t )(hil_optical_flow->sensor_id), (uint32_t )(hil_optical_flow->integration_time_us), (float )(hil_optical_flow->integrated_x), (float )(hil_optical_flow->integrated_y), (float )(hil_optical_flow->integrated_xgyro), (float )(hil_optical_flow->integrated_ygyro), (float )(hil_optical_flow->integrated_zgyro), (int16_t )(hil_optical_flow->temperature), (uint8_t )(hil_optical_flow->quality), (uint32_t )(hil_optical_flow->time_delta_distance_us), (float )(hil_optical_flow->distance));
}
...
{
    return mavlink_msg_hil_optical_flow_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_optical_flow->time_usec), (uint8_t )(hil_optical_flow->sensor_id), (uint32_t )(hil_optical_flow->integration_time_us), (float )(hil_optical_flow->integrated_x), (float )(hil_optical_flow->integrated_y), (float )(hil_optical_flow->integrated_xgyro), (float )(hil_optical_flow->integrated_ygyro), (float )(hil_optical_flow->integrated_zgyro), (int16_t )(hil_optical_flow->temperature), (uint8_t )(hil_optical_flow->quality), (uint32_t )(hil_optical_flow->time_delta_distance_us), (float )(hil_optical_flow->distance));
}
