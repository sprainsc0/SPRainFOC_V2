...
{
    return mavlink_msg_system_time_pack(system_id, component_id, msg, (uint64_t )(system_time->time_unix_usec), (uint32_t )(system_time->time_boot_ms));
}
...
{
    return mavlink_msg_system_time_pack_chan(system_id, component_id, chan, msg, (uint64_t )(system_time->time_unix_usec), (uint32_t )(system_time->time_boot_ms));
}
