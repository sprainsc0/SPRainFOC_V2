...
{
    return mavlink_msg_set_attitude_target_pack(system_id, component_id, msg, (uint32_t )(set_attitude_target->time_boot_ms), (uint8_t )(set_attitude_target->target_system), (uint8_t )(set_attitude_target->target_component), (uint8_t )(set_attitude_target->type_mask), (const float *)(set_attitude_target->q), (float )(set_attitude_target->body_roll_rate), (float )(set_attitude_target->body_pitch_rate), (float )(set_attitude_target->body_yaw_rate), (float )(set_attitude_target->thrust));
}
...
{
    return mavlink_msg_set_attitude_target_pack_chan(system_id, component_id, chan, msg, (uint32_t )(set_attitude_target->time_boot_ms), (uint8_t )(set_attitude_target->target_system), (uint8_t )(set_attitude_target->target_component), (uint8_t )(set_attitude_target->type_mask), (const float *)(set_attitude_target->q), (float )(set_attitude_target->body_roll_rate), (float )(set_attitude_target->body_pitch_rate), (float )(set_attitude_target->body_yaw_rate), (float )(set_attitude_target->thrust));
}
