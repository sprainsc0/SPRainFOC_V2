...
{
    return mavlink_msg_scaled_pressure_pack(system_id, component_id, msg, (uint32_t )(scaled_pressure->time_boot_ms), (float )(scaled_pressure->press_abs), (float )(scaled_pressure->press_diff), (int16_t )(scaled_pressure->temperature), (int16_t )(scaled_pressure->temperature_press_diff));
}
...
{
    return mavlink_msg_scaled_pressure_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_pressure->time_boot_ms), (float )(scaled_pressure->press_abs), (float )(scaled_pressure->press_diff), (int16_t )(scaled_pressure->temperature), (int16_t )(scaled_pressure->temperature_press_diff));
}
