...
{
    return mavlink_msg_memory_vect_pack(system_id, component_id, msg, (uint16_t )(memory_vect->address), (uint8_t )(memory_vect->ver), (uint8_t )(memory_vect->type), (const int8_t *)(memory_vect->value));
}
...
{
    return mavlink_msg_memory_vect_pack_chan(system_id, component_id, chan, msg, (uint16_t )(memory_vect->address), (uint8_t )(memory_vect->ver), (uint8_t )(memory_vect->type), (const int8_t *)(memory_vect->value));
}
