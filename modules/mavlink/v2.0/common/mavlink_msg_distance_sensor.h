...
{
    return mavlink_msg_distance_sensor_pack(system_id, component_id, msg, (uint32_t )(distance_sensor->time_boot_ms), (uint16_t )(distance_sensor->min_distance), (uint16_t )(distance_sensor->max_distance), (uint16_t )(distance_sensor->current_distance), (uint8_t )(distance_sensor->type), (uint8_t )(distance_sensor->id), (uint8_t )(distance_sensor->orientation), (uint8_t )(distance_sensor->covariance), (float )(distance_sensor->horizontal_fov), (float )(distance_sensor->vertical_fov), (const float *)(distance_sensor->quaternion), (uint8_t )(distance_sensor->signal_quality));
}
...
{
    return mavlink_msg_distance_sensor_pack_chan(system_id, component_id, chan, msg, (uint32_t )(distance_sensor->time_boot_ms), (uint16_t )(distance_sensor->min_distance), (uint16_t )(distance_sensor->max_distance), (uint16_t )(distance_sensor->current_distance), (uint8_t )(distance_sensor->type), (uint8_t )(distance_sensor->id), (uint8_t )(distance_sensor->orientation), (uint8_t )(distance_sensor->covariance), (float )(distance_sensor->horizontal_fov), (float )(distance_sensor->vertical_fov), (const float *)(distance_sensor->quaternion), (uint8_t )(distance_sensor->signal_quality));
}
