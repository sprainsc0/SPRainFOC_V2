...
{
    return mavlink_msg_log_erase_pack(system_id, component_id, msg, (uint8_t )(log_erase->target_system), (uint8_t )(log_erase->target_component));
}
...
{
    return mavlink_msg_log_erase_pack_chan(system_id, component_id, chan, msg, (uint8_t )(log_erase->target_system), (uint8_t )(log_erase->target_component));
}
