...
{
    return mavlink_msg_param_set_pack(system_id, component_id, msg, (uint8_t )(param_set->target_system), (uint8_t )(param_set->target_component), (const char *)(param_set->param_id), (float )(param_set->param_value), (uint8_t )(param_set->param_type));
}
...
{
    return mavlink_msg_param_set_pack_chan(system_id, component_id, chan, msg, (uint8_t )(param_set->target_system), (uint8_t )(param_set->target_component), (const char *)(param_set->param_id), (float )(param_set->param_value), (uint8_t )(param_set->param_type));
}
