...
{
    return mavlink_msg_gps_inject_data_pack(system_id, component_id, msg, (uint8_t )(gps_inject_data->target_system), (uint8_t )(gps_inject_data->target_component), (uint8_t )(gps_inject_data->len), (const uint8_t *)(gps_inject_data->data));
}
...
{
    return mavlink_msg_gps_inject_data_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gps_inject_data->target_system), (uint8_t )(gps_inject_data->target_component), (uint8_t )(gps_inject_data->len), (const uint8_t *)(gps_inject_data->data));
}
