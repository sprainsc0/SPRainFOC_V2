...
{
    return mavlink_msg_wind_cov_pack(system_id, component_id, msg, (uint64_t )(wind_cov->time_usec), (float )(wind_cov->wind_x), (float )(wind_cov->wind_y), (float )(wind_cov->wind_z), (float )(wind_cov->var_horiz), (float )(wind_cov->var_vert), (float )(wind_cov->wind_alt), (float )(wind_cov->horiz_accuracy), (float )(wind_cov->vert_accuracy));
}
...
{
    return mavlink_msg_wind_cov_pack_chan(system_id, component_id, chan, msg, (uint64_t )(wind_cov->time_usec), (float )(wind_cov->wind_x), (float )(wind_cov->wind_y), (float )(wind_cov->wind_z), (float )(wind_cov->var_horiz), (float )(wind_cov->var_vert), (float )(wind_cov->wind_alt), (float )(wind_cov->horiz_accuracy), (float )(wind_cov->vert_accuracy));
}
