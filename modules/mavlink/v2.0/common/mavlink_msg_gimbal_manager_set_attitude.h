...
{
    return mavlink_msg_gimbal_manager_set_attitude_pack(system_id, component_id, msg, (uint8_t )(gimbal_manager_set_attitude->target_system), (uint8_t )(gimbal_manager_set_attitude->target_component), (uint32_t )(gimbal_manager_set_attitude->flags), (uint8_t )(gimbal_manager_set_attitude->gimbal_device_id), (const float *)(gimbal_manager_set_attitude->q), (float )(gimbal_manager_set_attitude->angular_velocity_x), (float )(gimbal_manager_set_attitude->angular_velocity_y), (float )(gimbal_manager_set_attitude->angular_velocity_z));
}
...
{
    return mavlink_msg_gimbal_manager_set_attitude_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gimbal_manager_set_attitude->target_system), (uint8_t )(gimbal_manager_set_attitude->target_component), (uint32_t )(gimbal_manager_set_attitude->flags), (uint8_t )(gimbal_manager_set_attitude->gimbal_device_id), (const float *)(gimbal_manager_set_attitude->q), (float )(gimbal_manager_set_attitude->angular_velocity_x), (float )(gimbal_manager_set_attitude->angular_velocity_y), (float )(gimbal_manager_set_attitude->angular_velocity_z));
}
