...
{
    return mavlink_msg_altitude_pack(system_id, component_id, msg, (uint64_t )(altitude->time_usec), (float )(altitude->altitude_monotonic), (float )(altitude->altitude_amsl), (float )(altitude->altitude_local), (float )(altitude->altitude_relative), (float )(altitude->altitude_terrain), (float )(altitude->bottom_clearance));
}
...
{
    return mavlink_msg_altitude_pack_chan(system_id, component_id, chan, msg, (uint64_t )(altitude->time_usec), (float )(altitude->altitude_monotonic), (float )(altitude->altitude_amsl), (float )(altitude->altitude_local), (float )(altitude->altitude_relative), (float )(altitude->altitude_terrain), (float )(altitude->bottom_clearance));
}
