...
{
    return mavlink_msg_high_latency_pack(system_id, component_id, msg, (uint8_t )(high_latency->base_mode), (uint32_t )(high_latency->custom_mode), (uint8_t )(high_latency->landed_state), (int16_t )(high_latency->roll), (int16_t )(high_latency->pitch), (uint16_t )(high_latency->heading), (int8_t )(high_latency->throttle), (int16_t )(high_latency->heading_sp), (int32_t )(high_latency->latitude), (int32_t )(high_latency->longitude), (int16_t )(high_latency->altitude_amsl), (int16_t )(high_latency->altitude_sp), (uint8_t )(high_latency->airspeed), (uint8_t )(high_latency->airspeed_sp), (uint8_t )(high_latency->groundspeed), (int8_t )(high_latency->climb_rate), (uint8_t )(high_latency->gps_nsat), (uint8_t )(high_latency->gps_fix_type), (uint8_t )(high_latency->battery_remaining), (int8_t )(high_latency->temperature), (int8_t )(high_latency->temperature_air), (uint8_t )(high_latency->failsafe), (uint8_t )(high_latency->wp_num), (uint16_t )(high_latency->wp_distance));
}
...
{
    return mavlink_msg_high_latency_pack_chan(system_id, component_id, chan, msg, (uint8_t )(high_latency->base_mode), (uint32_t )(high_latency->custom_mode), (uint8_t )(high_latency->landed_state), (int16_t )(high_latency->roll), (int16_t )(high_latency->pitch), (uint16_t )(high_latency->heading), (int8_t )(high_latency->throttle), (int16_t )(high_latency->heading_sp), (int32_t )(high_latency->latitude), (int32_t )(high_latency->longitude), (int16_t )(high_latency->altitude_amsl), (int16_t )(high_latency->altitude_sp), (uint8_t )(high_latency->airspeed), (uint8_t )(high_latency->airspeed_sp), (uint8_t )(high_latency->groundspeed), (int8_t )(high_latency->climb_rate), (uint8_t )(high_latency->gps_nsat), (uint8_t )(high_latency->gps_fix_type), (uint8_t )(high_latency->battery_remaining), (int8_t )(high_latency->temperature), (int8_t )(high_latency->temperature_air), (uint8_t )(high_latency->failsafe), (uint8_t )(high_latency->wp_num), (uint16_t )(high_latency->wp_distance));
}
