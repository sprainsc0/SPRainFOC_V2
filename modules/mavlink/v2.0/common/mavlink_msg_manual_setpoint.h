...
{
    return mavlink_msg_manual_setpoint_pack(system_id, component_id, msg, (uint32_t )(manual_setpoint->time_boot_ms), (float )(manual_setpoint->roll), (float )(manual_setpoint->pitch), (float )(manual_setpoint->yaw), (float )(manual_setpoint->thrust), (uint8_t )(manual_setpoint->mode_switch), (uint8_t )(manual_setpoint->manual_override_switch));
}
...
{
    return mavlink_msg_manual_setpoint_pack_chan(system_id, component_id, chan, msg, (uint32_t )(manual_setpoint->time_boot_ms), (float )(manual_setpoint->roll), (float )(manual_setpoint->pitch), (float )(manual_setpoint->yaw), (float )(manual_setpoint->thrust), (uint8_t )(manual_setpoint->mode_switch), (uint8_t )(manual_setpoint->manual_override_switch));
}
