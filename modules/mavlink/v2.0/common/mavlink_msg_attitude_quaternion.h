...
{
    return mavlink_msg_attitude_quaternion_pack(system_id, component_id, msg, (uint32_t )(attitude_quaternion->time_boot_ms), (float )(attitude_quaternion->q1), (float )(attitude_quaternion->q2), (float )(attitude_quaternion->q3), (float )(attitude_quaternion->q4), (float )(attitude_quaternion->rollspeed), (float )(attitude_quaternion->pitchspeed), (float )(attitude_quaternion->yawspeed), (const float *)(attitude_quaternion->repr_offset_q));
}
...
{
    return mavlink_msg_attitude_quaternion_pack_chan(system_id, component_id, chan, msg, (uint32_t )(attitude_quaternion->time_boot_ms), (float )(attitude_quaternion->q1), (float )(attitude_quaternion->q2), (float )(attitude_quaternion->q3), (float )(attitude_quaternion->q4), (float )(attitude_quaternion->rollspeed), (float )(attitude_quaternion->pitchspeed), (float )(attitude_quaternion->yawspeed), (const float *)(attitude_quaternion->repr_offset_q));
}
