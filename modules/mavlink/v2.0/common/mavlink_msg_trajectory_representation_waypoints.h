...
{
    return mavlink_msg_trajectory_representation_waypoints_pack(system_id, component_id, msg, (uint64_t )(trajectory_representation_waypoints->time_usec), (uint8_t )(trajectory_representation_waypoints->valid_points), (const float *)(trajectory_representation_waypoints->pos_x), (const float *)(trajectory_representation_waypoints->pos_y), (const float *)(trajectory_representation_waypoints->pos_z), (const float *)(trajectory_representation_waypoints->vel_x), (const float *)(trajectory_representation_waypoints->vel_y), (const float *)(trajectory_representation_waypoints->vel_z), (const float *)(trajectory_representation_waypoints->acc_x), (const float *)(trajectory_representation_waypoints->acc_y), (const float *)(trajectory_representation_waypoints->acc_z), (const float *)(trajectory_representation_waypoints->pos_yaw), (const float *)(trajectory_representation_waypoints->vel_yaw), (const uint16_t *)(trajectory_representation_waypoints->command));
}
...
{
    return mavlink_msg_trajectory_representation_waypoints_pack_chan(system_id, component_id, chan, msg, (uint64_t )(trajectory_representation_waypoints->time_usec), (uint8_t )(trajectory_representation_waypoints->valid_points), (const float *)(trajectory_representation_waypoints->pos_x), (const float *)(trajectory_representation_waypoints->pos_y), (const float *)(trajectory_representation_waypoints->pos_z), (const float *)(trajectory_representation_waypoints->vel_x), (const float *)(trajectory_representation_waypoints->vel_y), (const float *)(trajectory_representation_waypoints->vel_z), (const float *)(trajectory_representation_waypoints->acc_x), (const float *)(trajectory_representation_waypoints->acc_y), (const float *)(trajectory_representation_waypoints->acc_z), (const float *)(trajectory_representation_waypoints->pos_yaw), (const float *)(trajectory_representation_waypoints->vel_yaw), (const uint16_t *)(trajectory_representation_waypoints->command));
}
