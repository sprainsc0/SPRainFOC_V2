...
{
    return mavlink_msg_actuator_output_status_pack(system_id, component_id, msg, (uint64_t )(actuator_output_status->time_usec), (uint32_t )(actuator_output_status->active), (const float *)(actuator_output_status->actuator));
}
...
{
    return mavlink_msg_actuator_output_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(actuator_output_status->time_usec), (uint32_t )(actuator_output_status->active), (const float *)(actuator_output_status->actuator));
}
