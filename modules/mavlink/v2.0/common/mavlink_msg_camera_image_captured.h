...
{
    return mavlink_msg_camera_image_captured_pack(system_id, component_id, msg, (uint32_t )(camera_image_captured->time_boot_ms), (uint64_t )(camera_image_captured->time_utc), (uint8_t )(camera_image_captured->camera_id), (int32_t )(camera_image_captured->lat), (int32_t )(camera_image_captured->lon), (int32_t )(camera_image_captured->alt), (int32_t )(camera_image_captured->relative_alt), (const float *)(camera_image_captured->q), (int32_t )(camera_image_captured->image_index), (int8_t )(camera_image_captured->capture_result), (const char *)(camera_image_captured->file_url));
}
...
{
    return mavlink_msg_camera_image_captured_pack_chan(system_id, component_id, chan, msg, (uint32_t )(camera_image_captured->time_boot_ms), (uint64_t )(camera_image_captured->time_utc), (uint8_t )(camera_image_captured->camera_id), (int32_t )(camera_image_captured->lat), (int32_t )(camera_image_captured->lon), (int32_t )(camera_image_captured->alt), (int32_t )(camera_image_captured->relative_alt), (const float *)(camera_image_captured->q), (int32_t )(camera_image_captured->image_index), (int8_t )(camera_image_captured->capture_result), (const char *)(camera_image_captured->file_url));
}
