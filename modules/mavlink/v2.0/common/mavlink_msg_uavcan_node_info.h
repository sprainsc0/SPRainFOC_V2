...
{
    return mavlink_msg_uavcan_node_info_pack(system_id, component_id, msg, (uint64_t )(uavcan_node_info->time_usec), (uint32_t )(uavcan_node_info->uptime_sec), (const char *)(uavcan_node_info->name), (uint8_t )(uavcan_node_info->hw_version_major), (uint8_t )(uavcan_node_info->hw_version_minor), (const uint8_t *)(uavcan_node_info->hw_unique_id), (uint8_t )(uavcan_node_info->sw_version_major), (uint8_t )(uavcan_node_info->sw_version_minor), (uint32_t )(uavcan_node_info->sw_vcs_commit));
}
...
{
    return mavlink_msg_uavcan_node_info_pack_chan(system_id, component_id, chan, msg, (uint64_t )(uavcan_node_info->time_usec), (uint32_t )(uavcan_node_info->uptime_sec), (const char *)(uavcan_node_info->name), (uint8_t )(uavcan_node_info->hw_version_major), (uint8_t )(uavcan_node_info->hw_version_minor), (const uint8_t *)(uavcan_node_info->hw_unique_id), (uint8_t )(uavcan_node_info->sw_version_major), (uint8_t )(uavcan_node_info->sw_version_minor), (uint32_t )(uavcan_node_info->sw_vcs_commit));
}
