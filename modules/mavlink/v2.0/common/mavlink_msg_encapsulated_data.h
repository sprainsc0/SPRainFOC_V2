...
{
    return mavlink_msg_encapsulated_data_pack(system_id, component_id, msg, (uint16_t )(encapsulated_data->seqnr), (const uint8_t *)(encapsulated_data->data));
}
...
{
    return mavlink_msg_encapsulated_data_pack_chan(system_id, component_id, chan, msg, (uint16_t )(encapsulated_data->seqnr), (const uint8_t *)(encapsulated_data->data));
}
