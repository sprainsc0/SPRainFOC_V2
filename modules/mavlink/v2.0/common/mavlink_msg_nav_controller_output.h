...
{
    return mavlink_msg_nav_controller_output_pack(system_id, component_id, msg, (float )(nav_controller_output->nav_roll), (float )(nav_controller_output->nav_pitch), (int16_t )(nav_controller_output->nav_bearing), (int16_t )(nav_controller_output->target_bearing), (uint16_t )(nav_controller_output->wp_dist), (float )(nav_controller_output->alt_error), (float )(nav_controller_output->aspd_error), (float )(nav_controller_output->xtrack_error));
}
...
{
    return mavlink_msg_nav_controller_output_pack_chan(system_id, component_id, chan, msg, (float )(nav_controller_output->nav_roll), (float )(nav_controller_output->nav_pitch), (int16_t )(nav_controller_output->nav_bearing), (int16_t )(nav_controller_output->target_bearing), (uint16_t )(nav_controller_output->wp_dist), (float )(nav_controller_output->alt_error), (float )(nav_controller_output->aspd_error), (float )(nav_controller_output->xtrack_error));
}
