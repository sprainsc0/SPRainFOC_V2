...
{
    return mavlink_msg_component_information_pack(system_id, component_id, msg, (uint32_t )(component_information->time_boot_ms), (uint32_t )(component_information->metadata_type), (uint32_t )(component_information->metadata_uid), (const char *)(component_information->metadata_uri), (uint32_t )(component_information->translation_uid), (const char *)(component_information->translation_uri));
}
...
{
    return mavlink_msg_component_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(component_information->time_boot_ms), (uint32_t )(component_information->metadata_type), (uint32_t )(component_information->metadata_uid), (const char *)(component_information->metadata_uri), (uint32_t )(component_information->translation_uid), (const char *)(component_information->translation_uri));
}
