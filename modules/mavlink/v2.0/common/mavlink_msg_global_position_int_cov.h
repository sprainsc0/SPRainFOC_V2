...
{
    return mavlink_msg_global_position_int_cov_pack(system_id, component_id, msg, (uint64_t )(global_position_int_cov->time_usec), (uint8_t )(global_position_int_cov->estimator_type), (int32_t )(global_position_int_cov->lat), (int32_t )(global_position_int_cov->lon), (int32_t )(global_position_int_cov->alt), (int32_t )(global_position_int_cov->relative_alt), (float )(global_position_int_cov->vx), (float )(global_position_int_cov->vy), (float )(global_position_int_cov->vz), (const float *)(global_position_int_cov->covariance));
}
...
{
    return mavlink_msg_global_position_int_cov_pack_chan(system_id, component_id, chan, msg, (uint64_t )(global_position_int_cov->time_usec), (uint8_t )(global_position_int_cov->estimator_type), (int32_t )(global_position_int_cov->lat), (int32_t )(global_position_int_cov->lon), (int32_t )(global_position_int_cov->alt), (int32_t )(global_position_int_cov->relative_alt), (float )(global_position_int_cov->vx), (float )(global_position_int_cov->vy), (float )(global_position_int_cov->vz), (const float *)(global_position_int_cov->covariance));
}
