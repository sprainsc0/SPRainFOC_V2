...
{
    return mavlink_msg_attitude_target_pack(system_id, component_id, msg, (uint32_t )(attitude_target->time_boot_ms), (uint8_t )(attitude_target->type_mask), (const float *)(attitude_target->q), (float )(attitude_target->body_roll_rate), (float )(attitude_target->body_pitch_rate), (float )(attitude_target->body_yaw_rate), (float )(attitude_target->thrust));
}
...
{
    return mavlink_msg_attitude_target_pack_chan(system_id, component_id, chan, msg, (uint32_t )(attitude_target->time_boot_ms), (uint8_t )(attitude_target->type_mask), (const float *)(attitude_target->q), (float )(attitude_target->body_roll_rate), (float )(attitude_target->body_pitch_rate), (float )(attitude_target->body_yaw_rate), (float )(attitude_target->thrust));
}
