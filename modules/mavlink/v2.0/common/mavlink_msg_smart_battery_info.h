...
{
    return mavlink_msg_smart_battery_info_pack(system_id, component_id, msg, (uint8_t )(smart_battery_info->id), (uint8_t )(smart_battery_info->battery_function), (uint8_t )(smart_battery_info->type), (int32_t )(smart_battery_info->capacity_full_specification), (int32_t )(smart_battery_info->capacity_full), (uint16_t )(smart_battery_info->cycle_count), (const char *)(smart_battery_info->serial_number), (const char *)(smart_battery_info->device_name), (uint16_t )(smart_battery_info->weight), (uint16_t )(smart_battery_info->discharge_minimum_voltage), (uint16_t )(smart_battery_info->charging_minimum_voltage), (uint16_t )(smart_battery_info->resting_minimum_voltage));
}
...
{
    return mavlink_msg_smart_battery_info_pack_chan(system_id, component_id, chan, msg, (uint8_t )(smart_battery_info->id), (uint8_t )(smart_battery_info->battery_function), (uint8_t )(smart_battery_info->type), (int32_t )(smart_battery_info->capacity_full_specification), (int32_t )(smart_battery_info->capacity_full), (uint16_t )(smart_battery_info->cycle_count), (const char *)(smart_battery_info->serial_number), (const char *)(smart_battery_info->device_name), (uint16_t )(smart_battery_info->weight), (uint16_t )(smart_battery_info->discharge_minimum_voltage), (uint16_t )(smart_battery_info->charging_minimum_voltage), (uint16_t )(smart_battery_info->resting_minimum_voltage));
}
