...
{
    return mavlink_msg_log_request_data_pack(system_id, component_id, msg, (uint8_t )(log_request_data->target_system), (uint8_t )(log_request_data->target_component), (uint16_t )(log_request_data->id), (uint32_t )(log_request_data->ofs), (uint32_t )(log_request_data->count));
}
...
{
    return mavlink_msg_log_request_data_pack_chan(system_id, component_id, chan, msg, (uint8_t )(log_request_data->target_system), (uint8_t )(log_request_data->target_component), (uint16_t )(log_request_data->id), (uint32_t )(log_request_data->ofs), (uint32_t )(log_request_data->count));
}
