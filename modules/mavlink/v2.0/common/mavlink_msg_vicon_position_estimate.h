...
{
    return mavlink_msg_vicon_position_estimate_pack(system_id, component_id, msg, (uint64_t )(vicon_position_estimate->usec), (float )(vicon_position_estimate->x), (float )(vicon_position_estimate->y), (float )(vicon_position_estimate->z), (float )(vicon_position_estimate->roll), (float )(vicon_position_estimate->pitch), (float )(vicon_position_estimate->yaw), (const float *)(vicon_position_estimate->covariance));
}
...
{
    return mavlink_msg_vicon_position_estimate_pack_chan(system_id, component_id, chan, msg, (uint64_t )(vicon_position_estimate->usec), (float )(vicon_position_estimate->x), (float )(vicon_position_estimate->y), (float )(vicon_position_estimate->z), (float )(vicon_position_estimate->roll), (float )(vicon_position_estimate->pitch), (float )(vicon_position_estimate->yaw), (const float *)(vicon_position_estimate->covariance));
}
