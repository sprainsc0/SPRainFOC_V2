...
{
    return mavlink_msg_landing_target_pack(system_id, component_id, msg, (uint64_t )(landing_target->time_usec), (uint8_t )(landing_target->target_num), (uint8_t )(landing_target->frame), (float )(landing_target->angle_x), (float )(landing_target->angle_y), (float )(landing_target->distance), (float )(landing_target->size_x), (float )(landing_target->size_y), (float )(landing_target->x), (float )(landing_target->y), (float )(landing_target->z), (const float *)(landing_target->q), (uint8_t )(landing_target->type), (uint8_t )(landing_target->position_valid));
}
...
{
    return mavlink_msg_landing_target_pack_chan(system_id, component_id, chan, msg, (uint64_t )(landing_target->time_usec), (uint8_t )(landing_target->target_num), (uint8_t )(landing_target->frame), (float )(landing_target->angle_x), (float )(landing_target->angle_y), (float )(landing_target->distance), (float )(landing_target->size_x), (float )(landing_target->size_y), (float )(landing_target->x), (float )(landing_target->y), (float )(landing_target->z), (const float *)(landing_target->q), (uint8_t )(landing_target->type), (uint8_t )(landing_target->position_valid));
}
