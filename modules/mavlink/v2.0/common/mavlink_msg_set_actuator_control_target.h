...
{
    return mavlink_msg_set_actuator_control_target_pack(system_id, component_id, msg, (uint64_t )(set_actuator_control_target->time_usec), (uint8_t )(set_actuator_control_target->group_mlx), (uint8_t )(set_actuator_control_target->target_system), (uint8_t )(set_actuator_control_target->target_component), (const float *)(set_actuator_control_target->controls));
}
...
{
    return mavlink_msg_set_actuator_control_target_pack_chan(system_id, component_id, chan, msg, (uint64_t )(set_actuator_control_target->time_usec), (uint8_t )(set_actuator_control_target->group_mlx), (uint8_t )(set_actuator_control_target->target_system), (uint8_t )(set_actuator_control_target->target_component), (const float *)(set_actuator_control_target->controls));
}
