...
{
    return mavlink_msg_mount_orientation_pack(system_id, component_id, msg, (uint32_t )(mount_orientation->time_boot_ms), (float )(mount_orientation->roll), (float )(mount_orientation->pitch), (float )(mount_orientation->yaw), (float )(mount_orientation->yaw_absolute));
}
...
{
    return mavlink_msg_mount_orientation_pack_chan(system_id, component_id, chan, msg, (uint32_t )(mount_orientation->time_boot_ms), (float )(mount_orientation->roll), (float )(mount_orientation->pitch), (float )(mount_orientation->yaw), (float )(mount_orientation->yaw_absolute));
}
