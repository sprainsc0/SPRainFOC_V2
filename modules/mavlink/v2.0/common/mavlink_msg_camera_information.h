...
{
    return mavlink_msg_camera_information_pack(system_id, component_id, msg, (uint32_t )(camera_information->time_boot_ms), (const uint8_t *)(camera_information->vendor_name), (const uint8_t *)(camera_information->model_name), (uint32_t )(camera_information->firmware_version), (float )(camera_information->focal_length), (float )(camera_information->sensor_size_h), (float )(camera_information->sensor_size_v), (uint16_t )(camera_information->resolution_h), (uint16_t )(camera_information->resolution_v), (uint8_t )(camera_information->lens_id), (uint32_t )(camera_information->flags), (uint16_t )(camera_information->cam_definition_version), (const char *)(camera_information->cam_definition_uri));
}
...
{
    return mavlink_msg_camera_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(camera_information->time_boot_ms), (const uint8_t *)(camera_information->vendor_name), (const uint8_t *)(camera_information->model_name), (uint32_t )(camera_information->firmware_version), (float )(camera_information->focal_length), (float )(camera_information->sensor_size_h), (float )(camera_information->sensor_size_v), (uint16_t )(camera_information->resolution_h), (uint16_t )(camera_information->resolution_v), (uint8_t )(camera_information->lens_id), (uint32_t )(camera_information->flags), (uint16_t )(camera_information->cam_definition_version), (const char *)(camera_information->cam_definition_uri));
}
