...
{
    return mavlink_msg_timesync_pack(system_id, component_id, msg, (int64_t )(timesync->tc1), (int64_t )(timesync->ts1));
}
...
{
    return mavlink_msg_timesync_pack_chan(system_id, component_id, chan, msg, (int64_t )(timesync->tc1), (int64_t )(timesync->ts1));
}
