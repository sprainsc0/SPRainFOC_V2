...
typedef struct __mavlink_rc_channels_override_t {
 ...
 uint16_t chan18_raw; /*< [us] RC channel 18 val1ue. A value of 0 or UINT16_MAX means to ignore this field. A value of UINT16_MAX-1 means to release this channel back to the RC radio.*/
 ...
 * @param chan18_raw [us] RC channel 18 val1ue. A value of 0 or UINT16_MAX means to ignore this field. A value of UINT16_MAX-1 means to release this channel back to the RC radio.
...
{
    return mavlink_msg_rc_channels_override_pack(system_id, component_id, msg, (uint8_t )(rc_channels_override->target_system), (uint8_t )(rc_channels_override->target_component), (uint16_t )(rc_channels_override->chan1_raw), (uint16_t )(rc_channels_override->chan2_raw), (uint16_t )(rc_channels_override->chan3_raw), (uint16_t )(rc_channels_override->chan4_raw), (uint16_t )(rc_channels_override->chan5_raw), (uint16_t )(rc_channels_override->chan6_raw), (uint16_t )(rc_channels_override->chan7_raw), (uint16_t )(rc_channels_override->chan8_raw), (uint16_t )(rc_channels_override->chan9_raw), (uint16_t )(rc_channels_override->chan10_raw), (uint16_t )(rc_channels_override->chan11_raw), (uint16_t )(rc_channels_override->chan12_raw), (uint16_t )(rc_channels_override->chan13_raw), (uint16_t )(rc_channels_override->chan14_raw), (uint16_t )(rc_channels_override->chan15_raw), (uint16_t )(rc_channels_override->chan16_raw), (uint16_t )(rc_channels_override->chan17_raw), (uint16_t )(rc_channels_override->chan18_raw));
}
...
{
    return mavlink_msg_rc_channels_override_pack_chan(system_id, component_id, chan, msg, (uint8_t )(rc_channels_override->target_system), (uint8_t )(rc_channels_override->target_component), (uint16_t )(rc_channels_override->chan1_raw), (uint16_t )(rc_channels_override->chan2_raw), (uint16_t )(rc_channels_override->chan3_raw), (uint16_t )(rc_channels_override->chan4_raw), (uint16_t )(rc_channels_override->chan5_raw), (uint16_t )(rc_channels_override->chan6_raw), (uint16_t )(rc_channels_override->chan7_raw), (uint16_t )(rc_channels_override->chan8_raw), (uint16_t )(rc_channels_override->chan9_raw), (uint16_t )(rc_channels_override->chan10_raw), (uint16_t )(rc_channels_override->chan11_raw), (uint16_t )(rc_channels_override->chan12_raw), (uint16_t )(rc_channels_override->chan13_raw), (uint16_t )(rc_channels_override->chan14_raw), (uint16_t )(rc_channels_override->chan15_raw), (uint16_t )(rc_channels_override->chan16_raw), (uint16_t )(rc_channels_override->chan17_raw), (uint16_t )(rc_channels_override->chan18_raw));
}
 ...
 *
 * @return [us] RC channel 18 val1ue. A value of 0 or UINT16_MAX means to ignore this field. A value of UINT16_MAX-1 means to release this channel back to the RC radio.
 */
