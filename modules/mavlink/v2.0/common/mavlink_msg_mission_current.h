...
{
    return mavlink_msg_mission_current_pack(system_id, component_id, msg, (uint16_t )(mission_current->seq));
}
...
{
    return mavlink_msg_mission_current_pack_chan(system_id, component_id, chan, msg, (uint16_t )(mission_current->seq));
}
