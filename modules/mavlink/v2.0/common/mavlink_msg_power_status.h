...
{
    return mavlink_msg_power_status_pack(system_id, component_id, msg, (uint16_t )(power_status->Vcc), (uint16_t )(power_status->Vservo), (uint16_t )(power_status->flags));
}
...
{
    return mavlink_msg_power_status_pack_chan(system_id, component_id, chan, msg, (uint16_t )(power_status->Vcc), (uint16_t )(power_status->Vservo), (uint16_t )(power_status->flags));
}
