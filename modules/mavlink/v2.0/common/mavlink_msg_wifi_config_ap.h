...
{
    return mavlink_msg_wifi_config_ap_pack(system_id, component_id, msg, (const char *)(wifi_config_ap->ssid), (const char *)(wifi_config_ap->password), (int8_t )(wifi_config_ap->mode), (int8_t )(wifi_config_ap->response));
}
...
{
    return mavlink_msg_wifi_config_ap_pack_chan(system_id, component_id, chan, msg, (const char *)(wifi_config_ap->ssid), (const char *)(wifi_config_ap->password), (int8_t )(wifi_config_ap->mode), (int8_t )(wifi_config_ap->response));
}
