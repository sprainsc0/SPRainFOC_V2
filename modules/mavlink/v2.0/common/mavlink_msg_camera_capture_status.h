...
{
    return mavlink_msg_camera_capture_status_pack(system_id, component_id, msg, (uint32_t )(camera_capture_status->time_boot_ms), (uint8_t )(camera_capture_status->image_status), (uint8_t )(camera_capture_status->video_status), (float )(camera_capture_status->image_interval), (uint32_t )(camera_capture_status->recording_time_ms), (float )(camera_capture_status->available_capacity), (int32_t )(camera_capture_status->image_count));
}
...
{
    return mavlink_msg_camera_capture_status_pack_chan(system_id, component_id, chan, msg, (uint32_t )(camera_capture_status->time_boot_ms), (uint8_t )(camera_capture_status->image_status), (uint8_t )(camera_capture_status->video_status), (float )(camera_capture_status->image_interval), (uint32_t )(camera_capture_status->recording_time_ms), (float )(camera_capture_status->available_capacity), (int32_t )(camera_capture_status->image_count));
}
