...
{
    return mavlink_msg_time_estimate_to_target_pack(system_id, component_id, msg, (int32_t )(time_estimate_to_target->safe_return), (int32_t )(time_estimate_to_target->land), (int32_t )(time_estimate_to_target->mission_next_item), (int32_t )(time_estimate_to_target->mission_end), (int32_t )(time_estimate_to_target->commanded_action));
}
...
{
    return mavlink_msg_time_estimate_to_target_pack_chan(system_id, component_id, chan, msg, (int32_t )(time_estimate_to_target->safe_return), (int32_t )(time_estimate_to_target->land), (int32_t )(time_estimate_to_target->mission_next_item), (int32_t )(time_estimate_to_target->mission_end), (int32_t )(time_estimate_to_target->commanded_action));
}
