...
{
    return mavlink_msg_log_data_pack(system_id, component_id, msg, (uint16_t )(log_data->id), (uint32_t )(log_data->ofs), (uint8_t )(log_data->count), (const uint8_t *)(log_data->data));
}
...
{
    return mavlink_msg_log_data_pack_chan(system_id, component_id, chan, msg, (uint16_t )(log_data->id), (uint32_t )(log_data->ofs), (uint8_t )(log_data->count), (const uint8_t *)(log_data->data));
}
