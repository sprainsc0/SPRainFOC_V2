...
{
    return mavlink_msg_hil_state_pack(system_id, component_id, msg, (uint64_t )(hil_state->time_usec), (float )(hil_state->roll), (float )(hil_state->pitch), (float )(hil_state->yaw), (float )(hil_state->rollspeed), (float )(hil_state->pitchspeed), (float )(hil_state->yawspeed), (int32_t )(hil_state->lat), (int32_t )(hil_state->lon), (int32_t )(hil_state->alt), (int16_t )(hil_state->vx), (int16_t )(hil_state->vy), (int16_t )(hil_state->vz), (int16_t )(hil_state->xacc), (int16_t )(hil_state->yacc), (int16_t )(hil_state->zacc));
}
...
{
    return mavlink_msg_hil_state_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_state->time_usec), (float )(hil_state->roll), (float )(hil_state->pitch), (float )(hil_state->yaw), (float )(hil_state->rollspeed), (float )(hil_state->pitchspeed), (float )(hil_state->yawspeed), (int32_t )(hil_state->lat), (int32_t )(hil_state->lon), (int32_t )(hil_state->alt), (int16_t )(hil_state->vx), (int16_t )(hil_state->vy), (int16_t )(hil_state->vz), (int16_t )(hil_state->xacc), (int16_t )(hil_state->yacc), (int16_t )(hil_state->zacc));
}
