...
{
    return mavlink_msg_safety_set_allowed_area_pack(system_id, component_id, msg, (uint8_t )(safety_set_allowed_area->target_system), (uint8_t )(safety_set_allowed_area->target_component), (uint8_t )(safety_set_allowed_area->frame), (float )(safety_set_allowed_area->p1x), (float )(safety_set_allowed_area->p1y), (float )(safety_set_allowed_area->p1z), (float )(safety_set_allowed_area->p2x), (float )(safety_set_allowed_area->p2y), (float )(safety_set_allowed_area->p2z));
}
...
{
    return mavlink_msg_safety_set_allowed_area_pack_chan(system_id, component_id, chan, msg, (uint8_t )(safety_set_allowed_area->target_system), (uint8_t )(safety_set_allowed_area->target_component), (uint8_t )(safety_set_allowed_area->frame), (float )(safety_set_allowed_area->p1x), (float )(safety_set_allowed_area->p1y), (float )(safety_set_allowed_area->p1z), (float )(safety_set_allowed_area->p2x), (float )(safety_set_allowed_area->p2y), (float )(safety_set_allowed_area->p2z));
}
