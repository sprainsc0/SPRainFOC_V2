...
{
    return mavlink_msg_rc_channels_raw_pack(system_id, component_id, msg, (uint32_t )(rc_channels_raw->time_boot_ms), (uint8_t )(rc_channels_raw->port), (uint16_t )(rc_channels_raw->chan1_raw), (uint16_t )(rc_channels_raw->chan2_raw), (uint16_t )(rc_channels_raw->chan3_raw), (uint16_t )(rc_channels_raw->chan4_raw), (uint16_t )(rc_channels_raw->chan5_raw), (uint16_t )(rc_channels_raw->chan6_raw), (uint16_t )(rc_channels_raw->chan7_raw), (uint16_t )(rc_channels_raw->chan8_raw), (uint8_t )(rc_channels_raw->rssi));
}
...
{
    return mavlink_msg_rc_channels_raw_pack_chan(system_id, component_id, chan, msg, (uint32_t )(rc_channels_raw->time_boot_ms), (uint8_t )(rc_channels_raw->port), (uint16_t )(rc_channels_raw->chan1_raw), (uint16_t )(rc_channels_raw->chan2_raw), (uint16_t )(rc_channels_raw->chan3_raw), (uint16_t )(rc_channels_raw->chan4_raw), (uint16_t )(rc_channels_raw->chan5_raw), (uint16_t )(rc_channels_raw->chan6_raw), (uint16_t )(rc_channels_raw->chan7_raw), (uint16_t )(rc_channels_raw->chan8_raw), (uint8_t )(rc_channels_raw->rssi));
}
