...
{
    return mavlink_msg_vision_position_estimate_pack(system_id, component_id, msg, (uint64_t )(vision_position_estimate->usec), (float )(vision_position_estimate->x), (float )(vision_position_estimate->y), (float )(vision_position_estimate->z), (float )(vision_position_estimate->roll), (float )(vision_position_estimate->pitch), (float )(vision_position_estimate->yaw), (const float *)(vision_position_estimate->covariance), (uint8_t )(vision_position_estimate->reset_counter));
}
...
{
    return mavlink_msg_vision_position_estimate_pack_chan(system_id, component_id, chan, msg, (uint64_t )(vision_position_estimate->usec), (float )(vision_position_estimate->x), (float )(vision_position_estimate->y), (float )(vision_position_estimate->z), (float )(vision_position_estimate->roll), (float )(vision_position_estimate->pitch), (float )(vision_position_estimate->yaw), (const float *)(vision_position_estimate->covariance), (uint8_t )(vision_position_estimate->reset_counter));
}
