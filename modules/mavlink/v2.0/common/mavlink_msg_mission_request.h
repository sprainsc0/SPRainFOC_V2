...
{
    return mavlink_msg_mission_request_pack(system_id, component_id, msg, (uint8_t )(mission_request->target_system), (uint8_t )(mission_request->target_component), (uint16_t )(mission_request->seq), (uint8_t )(mission_request->mission_type));
}
...
{
    return mavlink_msg_mission_request_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request->target_system), (uint8_t )(mission_request->target_component), (uint16_t )(mission_request->seq), (uint8_t )(mission_request->mission_type));
}
