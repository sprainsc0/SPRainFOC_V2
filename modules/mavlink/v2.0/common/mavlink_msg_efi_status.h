...
{
    return mavlink_msg_efi_status_pack(system_id, component_id, msg, (uint8_t )(efi_status->health), (float )(efi_status->ecu_index), (float )(efi_status->rpm), (float )(efi_status->fuel_consumed), (float )(efi_status->fuel_flow), (float )(efi_status->engine_load), (float )(efi_status->throttle_position), (float )(efi_status->spark_dwell_time), (float )(efi_status->barometric_pressure), (float )(efi_status->intake_manifold_pressure), (float )(efi_status->intake_manifold_temperature), (float )(efi_status->cylinder_head_temperature), (float )(efi_status->ignition_timing), (float )(efi_status->injection_time), (float )(efi_status->exhaust_gas_temperature), (float )(efi_status->throttle_out), (float )(efi_status->pt_compensation));
}
...
{
    return mavlink_msg_efi_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(efi_status->health), (float )(efi_status->ecu_index), (float )(efi_status->rpm), (float )(efi_status->fuel_consumed), (float )(efi_status->fuel_flow), (float )(efi_status->engine_load), (float )(efi_status->throttle_position), (float )(efi_status->spark_dwell_time), (float )(efi_status->barometric_pressure), (float )(efi_status->intake_manifold_pressure), (float )(efi_status->intake_manifold_temperature), (float )(efi_status->cylinder_head_temperature), (float )(efi_status->ignition_timing), (float )(efi_status->injection_time), (float )(efi_status->exhaust_gas_temperature), (float )(efi_status->throttle_out), (float )(efi_status->pt_compensation));
}
