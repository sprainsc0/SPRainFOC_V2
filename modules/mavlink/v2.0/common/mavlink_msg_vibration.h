...
{
    return mavlink_msg_vibration_pack(system_id, component_id, msg, (uint64_t )(vibration->time_usec), (float )(vibration->vibration_x), (float )(vibration->vibration_y), (float )(vibration->vibration_z), (uint32_t )(vibration->clipping_0), (uint32_t )(vibration->clipping_1), (uint32_t )(vibration->clipping_2));
}
...
{
    return mavlink_msg_vibration_pack_chan(system_id, component_id, chan, msg, (uint64_t )(vibration->time_usec), (float )(vibration->vibration_x), (float )(vibration->vibration_y), (float )(vibration->vibration_z), (uint32_t )(vibration->clipping_0), (uint32_t )(vibration->clipping_1), (uint32_t )(vibration->clipping_2));
}
