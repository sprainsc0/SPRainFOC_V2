...
{
    return mavlink_msg_open_drone_id_basic_id_pack(system_id, component_id, msg, (uint8_t )(open_drone_id_basic_id->target_system), (uint8_t )(open_drone_id_basic_id->target_component), (const uint8_t *)(open_drone_id_basic_id->id_or_mac), (uint8_t )(open_drone_id_basic_id->id_type), (uint8_t )(open_drone_id_basic_id->ua_type), (const uint8_t *)(open_drone_id_basic_id->uas_id));
}
...
{
    return mavlink_msg_open_drone_id_basic_id_pack_chan(system_id, component_id, chan, msg, (uint8_t )(open_drone_id_basic_id->target_system), (uint8_t )(open_drone_id_basic_id->target_component), (const uint8_t *)(open_drone_id_basic_id->id_or_mac), (uint8_t )(open_drone_id_basic_id->id_type), (uint8_t )(open_drone_id_basic_id->ua_type), (const uint8_t *)(open_drone_id_basic_id->uas_id));
}
