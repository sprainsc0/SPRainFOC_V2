...
{
    return mavlink_msg_mission_item_int_pack(system_id, component_id, msg, (uint8_t )(mission_item_int->target_system), (uint8_t )(mission_item_int->target_component), (uint16_t )(mission_item_int->seq), (uint8_t )(mission_item_int->frame), (uint16_t )(mission_item_int->command), (uint8_t )(mission_item_int->current), (uint8_t )(mission_item_int->autocontinue), (float )(mission_item_int->param1), (float )(mission_item_int->param2), (float )(mission_item_int->param3), (float )(mission_item_int->param4), (int32_t )(mission_item_int->x), (int32_t )(mission_item_int->y), (float )(mission_item_int->z), (uint8_t )(mission_item_int->mission_type));
}
...
{
    return mavlink_msg_mission_item_int_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_item_int->target_system), (uint8_t )(mission_item_int->target_component), (uint16_t )(mission_item_int->seq), (uint8_t )(mission_item_int->frame), (uint16_t )(mission_item_int->command), (uint8_t )(mission_item_int->current), (uint8_t )(mission_item_int->autocontinue), (float )(mission_item_int->param1), (float )(mission_item_int->param2), (float )(mission_item_int->param3), (float )(mission_item_int->param4), (int32_t )(mission_item_int->x), (int32_t )(mission_item_int->y), (float )(mission_item_int->z), (uint8_t )(mission_item_int->mission_type));
}
