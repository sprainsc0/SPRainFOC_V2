...
{
    return mavlink_msg_collision_pack(system_id, component_id, msg, (uint8_t )(collision->src), (uint32_t )(collision->id), (uint8_t )(collision->action), (uint8_t )(collision->threat_level), (float )(collision->time_to_minimum_delta), (float )(collision->altitude_minimum_delta), (float )(collision->horizontal_minimum_delta));
}
...
{
    return mavlink_msg_collision_pack_chan(system_id, component_id, chan, msg, (uint8_t )(collision->src), (uint32_t )(collision->id), (uint8_t )(collision->action), (uint8_t )(collision->threat_level), (float )(collision->time_to_minimum_delta), (float )(collision->altitude_minimum_delta), (float )(collision->horizontal_minimum_delta));
}
