...
{
    return mavlink_msg_mission_request_int_pack(system_id, component_id, msg, (uint8_t )(mission_request_int->target_system), (uint8_t )(mission_request_int->target_component), (uint16_t )(mission_request_int->seq), (uint8_t )(mission_request_int->mission_type));
}
...
{
    return mavlink_msg_mission_request_int_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request_int->target_system), (uint8_t )(mission_request_int->target_component), (uint16_t )(mission_request_int->seq), (uint8_t )(mission_request_int->mission_type));
}
