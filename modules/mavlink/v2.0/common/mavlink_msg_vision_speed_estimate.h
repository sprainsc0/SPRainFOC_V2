...
{
    return mavlink_msg_vision_speed_estimate_pack(system_id, component_id, msg, (uint64_t )(vision_speed_estimate->usec), (float )(vision_speed_estimate->x), (float )(vision_speed_estimate->y), (float )(vision_speed_estimate->z), (const float *)(vision_speed_estimate->covariance), (uint8_t )(vision_speed_estimate->reset_counter));
}
...
{
    return mavlink_msg_vision_speed_estimate_pack_chan(system_id, component_id, chan, msg, (uint64_t )(vision_speed_estimate->usec), (float )(vision_speed_estimate->x), (float )(vision_speed_estimate->y), (float )(vision_speed_estimate->z), (const float *)(vision_speed_estimate->covariance), (uint8_t )(vision_speed_estimate->reset_counter));
}
