...
{
    return mavlink_msg_param_value_pack(system_id, component_id, msg, (const char *)(param_value->param_id), (float )(param_value->param_value), (uint8_t )(param_value->param_type), (uint16_t )(param_value->param_count), (uint16_t )(param_value->param_index));
}
...
{
    return mavlink_msg_param_value_pack_chan(system_id, component_id, chan, msg, (const char *)(param_value->param_id), (float )(param_value->param_value), (uint8_t )(param_value->param_type), (uint16_t )(param_value->param_count), (uint16_t )(param_value->param_index));
}
