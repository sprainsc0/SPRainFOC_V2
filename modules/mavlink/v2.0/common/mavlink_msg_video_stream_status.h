...
{
    return mavlink_msg_video_stream_status_pack(system_id, component_id, msg, (uint8_t )(video_stream_status->stream_id), (uint16_t )(video_stream_status->flags), (float )(video_stream_status->framerate), (uint16_t )(video_stream_status->resolution_h), (uint16_t )(video_stream_status->resolution_v), (uint32_t )(video_stream_status->bitrate), (uint16_t )(video_stream_status->rotation), (uint16_t )(video_stream_status->hfov));
}
...
{
    return mavlink_msg_video_stream_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(video_stream_status->stream_id), (uint16_t )(video_stream_status->flags), (float )(video_stream_status->framerate), (uint16_t )(video_stream_status->resolution_h), (uint16_t )(video_stream_status->resolution_v), (uint32_t )(video_stream_status->bitrate), (uint16_t )(video_stream_status->rotation), (uint16_t )(video_stream_status->hfov));
}
