...
{
    return mavlink_msg_ais_vessel_pack(system_id, component_id, msg, (uint32_t )(ais_vessel->MMSI), (int32_t )(ais_vessel->lat), (int32_t )(ais_vessel->lon), (uint16_t )(ais_vessel->COG), (uint16_t )(ais_vessel->heading), (uint16_t )(ais_vessel->velocity), (int8_t )(ais_vessel->turn_rate), (uint8_t )(ais_vessel->navigational_status), (uint8_t )(ais_vessel->type), (uint16_t )(ais_vessel->dimension_bow), (uint16_t )(ais_vessel->dimension_stern), (uint8_t )(ais_vessel->dimension_port), (uint8_t )(ais_vessel->dimension_starboard), (const char *)(ais_vessel->callsign), (const char *)(ais_vessel->name), (uint16_t )(ais_vessel->tslc), (uint16_t )(ais_vessel->flags));
}
...
{
    return mavlink_msg_ais_vessel_pack_chan(system_id, component_id, chan, msg, (uint32_t )(ais_vessel->MMSI), (int32_t )(ais_vessel->lat), (int32_t )(ais_vessel->lon), (uint16_t )(ais_vessel->COG), (uint16_t )(ais_vessel->heading), (uint16_t )(ais_vessel->velocity), (int8_t )(ais_vessel->turn_rate), (uint8_t )(ais_vessel->navigational_status), (uint8_t )(ais_vessel->type), (uint16_t )(ais_vessel->dimension_bow), (uint16_t )(ais_vessel->dimension_stern), (uint8_t )(ais_vessel->dimension_port), (uint8_t )(ais_vessel->dimension_starboard), (const char *)(ais_vessel->callsign), (const char *)(ais_vessel->name), (uint16_t )(ais_vessel->tslc), (uint16_t )(ais_vessel->flags));
}
