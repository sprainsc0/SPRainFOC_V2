...
{
    return mavlink_msg_message_interval_pack(system_id, component_id, msg, (uint16_t )(message_interval->message_id), (int32_t )(message_interval->interval_us));
}
...
{
    return mavlink_msg_message_interval_pack_chan(system_id, component_id, chan, msg, (uint16_t )(message_interval->message_id), (int32_t )(message_interval->interval_us));
}
