...
{
    return mavlink_msg_param_ext_request_list_pack(system_id, component_id, msg, (uint8_t )(param_ext_request_list->target_system), (uint8_t )(param_ext_request_list->target_component));
}
...
{
    return mavlink_msg_param_ext_request_list_pack_chan(system_id, component_id, chan, msg, (uint8_t )(param_ext_request_list->target_system), (uint8_t )(param_ext_request_list->target_component));
}
