...
{
    return mavlink_msg_obstacle_distance_pack(system_id, component_id, msg, (uint64_t )(obstacle_distance->time_usec), (uint8_t )(obstacle_distance->sensor_type), (const uint16_t *)(obstacle_distance->distances), (uint8_t )(obstacle_distance->increment), (uint16_t )(obstacle_distance->min_distance), (uint16_t )(obstacle_distance->max_distance), (float )(obstacle_distance->increment_f), (float )(obstacle_distance->angle_offset), (uint8_t )(obstacle_distance->frame));
}
...
{
    return mavlink_msg_obstacle_distance_pack_chan(system_id, component_id, chan, msg, (uint64_t )(obstacle_distance->time_usec), (uint8_t )(obstacle_distance->sensor_type), (const uint16_t *)(obstacle_distance->distances), (uint8_t )(obstacle_distance->increment), (uint16_t )(obstacle_distance->min_distance), (uint16_t )(obstacle_distance->max_distance), (float )(obstacle_distance->increment_f), (float )(obstacle_distance->angle_offset), (uint8_t )(obstacle_distance->frame));
}
