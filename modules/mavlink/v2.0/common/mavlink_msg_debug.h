...
{
    return mavlink_msg_debug_pack(system_id, component_id, msg, (uint32_t )(debug->time_boot_ms), (uint8_t )(debug->ind), (float )(debug->value));
}
...
{
    return mavlink_msg_debug_pack_chan(system_id, component_id, chan, msg, (uint32_t )(debug->time_boot_ms), (uint8_t )(debug->ind), (float )(debug->value));
}
