...
{
    return mavlink_msg_request_data_stream_pack(system_id, component_id, msg, (uint8_t )(request_data_stream->target_system), (uint8_t )(request_data_stream->target_component), (uint8_t )(request_data_stream->req_stream_id), (uint16_t )(request_data_stream->req_message_rate), (uint8_t )(request_data_stream->start_stop));
}
...
{
    return mavlink_msg_request_data_stream_pack_chan(system_id, component_id, chan, msg, (uint8_t )(request_data_stream->target_system), (uint8_t )(request_data_stream->target_component), (uint8_t )(request_data_stream->req_stream_id), (uint16_t )(request_data_stream->req_message_rate), (uint8_t )(request_data_stream->start_stop));
}
