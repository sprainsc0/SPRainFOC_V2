...
{
    return mavlink_msg_v2_extension_pack(system_id, component_id, msg, (uint8_t )(v2_extension->target_network), (uint8_t )(v2_extension->target_system), (uint8_t )(v2_extension->target_component), (uint16_t )(v2_extension->message_type), (const uint8_t *)(v2_extension->payload));
}
...
{
    return mavlink_msg_v2_extension_pack_chan(system_id, component_id, chan, msg, (uint8_t )(v2_extension->target_network), (uint8_t )(v2_extension->target_system), (uint8_t )(v2_extension->target_component), (uint16_t )(v2_extension->message_type), (const uint8_t *)(v2_extension->payload));
}
