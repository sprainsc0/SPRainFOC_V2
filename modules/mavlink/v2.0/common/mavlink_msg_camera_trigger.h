...
{
    return mavlink_msg_camera_trigger_pack(system_id, component_id, msg, (uint64_t )(camera_trigger->time_usec), (uint32_t )(camera_trigger->seq));
}
...
{
    return mavlink_msg_camera_trigger_pack_chan(system_id, component_id, chan, msg, (uint64_t )(camera_trigger->time_usec), (uint32_t )(camera_trigger->seq));
}
