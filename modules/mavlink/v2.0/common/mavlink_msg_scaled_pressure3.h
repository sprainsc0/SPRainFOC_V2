...
{
    return mavlink_msg_scaled_pressure3_pack(system_id, component_id, msg, (uint32_t )(scaled_pressure3->time_boot_ms), (float )(scaled_pressure3->press_abs), (float )(scaled_pressure3->press_diff), (int16_t )(scaled_pressure3->temperature), (int16_t )(scaled_pressure3->temperature_press_diff));
}
...
{
    return mavlink_msg_scaled_pressure3_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_pressure3->time_boot_ms), (float )(scaled_pressure3->press_abs), (float )(scaled_pressure3->press_diff), (int16_t )(scaled_pressure3->temperature), (int16_t )(scaled_pressure3->temperature_press_diff));
}
