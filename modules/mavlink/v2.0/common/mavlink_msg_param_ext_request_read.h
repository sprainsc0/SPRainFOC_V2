...
{
    return mavlink_msg_param_ext_request_read_pack(system_id, component_id, msg, (uint8_t )(param_ext_request_read->target_system), (uint8_t )(param_ext_request_read->target_component), (const char *)(param_ext_request_read->param_id), (int16_t )(param_ext_request_read->param_index));
}
...
{
    return mavlink_msg_param_ext_request_read_pack_chan(system_id, component_id, chan, msg, (uint8_t )(param_ext_request_read->target_system), (uint8_t )(param_ext_request_read->target_component), (const char *)(param_ext_request_read->param_id), (int16_t )(param_ext_request_read->param_index));
}
