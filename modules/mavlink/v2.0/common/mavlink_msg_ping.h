...
{
    return mavlink_msg_ping_pack(system_id, component_id, msg, (uint64_t )(ping->time_usec), (uint32_t )(ping->seq), (uint8_t )(ping->target_system), (uint8_t )(ping->target_component));
}
...
{
    return mavlink_msg_ping_pack_chan(system_id, component_id, chan, msg, (uint64_t )(ping->time_usec), (uint32_t )(ping->seq), (uint8_t )(ping->target_system), (uint8_t )(ping->target_component));
}
