...
{
    return mavlink_msg_play_tune_pack(system_id, component_id, msg, (uint8_t )(play_tune->target_system), (uint8_t )(play_tune->target_component), (const char *)(play_tune->tune), (const char *)(play_tune->tune2));
}
...
{
    return mavlink_msg_play_tune_pack_chan(system_id, component_id, chan, msg, (uint8_t )(play_tune->target_system), (uint8_t )(play_tune->target_component), (const char *)(play_tune->tune), (const char *)(play_tune->tune2));
}
