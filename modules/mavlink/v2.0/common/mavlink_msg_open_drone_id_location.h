...
{
    return mavlink_msg_open_drone_id_location_pack(system_id, component_id, msg, (uint8_t )(open_drone_id_location->target_system), (uint8_t )(open_drone_id_location->target_component), (const uint8_t *)(open_drone_id_location->id_or_mac), (uint8_t )(open_drone_id_location->status), (uint16_t )(open_drone_id_location->direction), (uint16_t )(open_drone_id_location->speed_horizontal), (int16_t )(open_drone_id_location->speed_vertical), (int32_t )(open_drone_id_location->latitude), (int32_t )(open_drone_id_location->longitude), (float )(open_drone_id_location->altitude_barometric), (float )(open_drone_id_location->altitude_geodetic), (uint8_t )(open_drone_id_location->height_reference), (float )(open_drone_id_location->height), (uint8_t )(open_drone_id_location->horizontal_accuracy), (uint8_t )(open_drone_id_location->vertical_accuracy), (uint8_t )(open_drone_id_location->barometer_accuracy), (uint8_t )(open_drone_id_location->speed_accuracy), (float )(open_drone_id_location->timestamp), (uint8_t )(open_drone_id_location->timestamp_accuracy));
}
...
{
    return mavlink_msg_open_drone_id_location_pack_chan(system_id, component_id, chan, msg, (uint8_t )(open_drone_id_location->target_system), (uint8_t )(open_drone_id_location->target_component), (const uint8_t *)(open_drone_id_location->id_or_mac), (uint8_t )(open_drone_id_location->status), (uint16_t )(open_drone_id_location->direction), (uint16_t )(open_drone_id_location->speed_horizontal), (int16_t )(open_drone_id_location->speed_vertical), (int32_t )(open_drone_id_location->latitude), (int32_t )(open_drone_id_location->longitude), (float )(open_drone_id_location->altitude_barometric), (float )(open_drone_id_location->altitude_geodetic), (uint8_t )(open_drone_id_location->height_reference), (float )(open_drone_id_location->height), (uint8_t )(open_drone_id_location->horizontal_accuracy), (uint8_t )(open_drone_id_location->vertical_accuracy), (uint8_t )(open_drone_id_location->barometer_accuracy), (uint8_t )(open_drone_id_location->speed_accuracy), (float )(open_drone_id_location->timestamp), (uint8_t )(open_drone_id_location->timestamp_accuracy));
}
