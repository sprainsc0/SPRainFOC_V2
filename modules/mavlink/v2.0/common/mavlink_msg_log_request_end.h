...
{
    return mavlink_msg_log_request_end_pack(system_id, component_id, msg, (uint8_t )(log_request_end->target_system), (uint8_t )(log_request_end->target_component));
}
...
{
    return mavlink_msg_log_request_end_pack_chan(system_id, component_id, chan, msg, (uint8_t )(log_request_end->target_system), (uint8_t )(log_request_end->target_component));
}
