...
{
    return mavlink_msg_control_system_state_pack(system_id, component_id, msg, (uint64_t )(control_system_state->time_usec), (float )(control_system_state->x_acc), (float )(control_system_state->y_acc), (float )(control_system_state->z_acc), (float )(control_system_state->x_vel), (float )(control_system_state->y_vel), (float )(control_system_state->z_vel), (float )(control_system_state->x_pos), (float )(control_system_state->y_pos), (float )(control_system_state->z_pos), (float )(control_system_state->airspeed), (const float *)(control_system_state->vel_variance), (const float *)(control_system_state->pos_variance), (const float *)(control_system_state->q), (float )(control_system_state->roll_rate), (float )(control_system_state->pitch_rate), (float )(control_system_state->yaw_rate));
}
...
{
    return mavlink_msg_control_system_state_pack_chan(system_id, component_id, chan, msg, (uint64_t )(control_system_state->time_usec), (float )(control_system_state->x_acc), (float )(control_system_state->y_acc), (float )(control_system_state->z_acc), (float )(control_system_state->x_vel), (float )(control_system_state->y_vel), (float )(control_system_state->z_vel), (float )(control_system_state->x_pos), (float )(control_system_state->y_pos), (float )(control_system_state->z_pos), (float )(control_system_state->airspeed), (const float *)(control_system_state->vel_variance), (const float *)(control_system_state->pos_variance), (const float *)(control_system_state->q), (float )(control_system_state->roll_rate), (float )(control_system_state->pitch_rate), (float )(control_system_state->yaw_rate));
}
