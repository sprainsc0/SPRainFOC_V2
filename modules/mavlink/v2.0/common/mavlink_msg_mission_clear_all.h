...
{
    return mavlink_msg_mission_clear_all_pack(system_id, component_id, msg, (uint8_t )(mission_clear_all->target_system), (uint8_t )(mission_clear_all->target_component), (uint8_t )(mission_clear_all->mission_type));
}
...
{
    return mavlink_msg_mission_clear_all_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_clear_all->target_system), (uint8_t )(mission_clear_all->target_component), (uint8_t )(mission_clear_all->mission_type));
}
