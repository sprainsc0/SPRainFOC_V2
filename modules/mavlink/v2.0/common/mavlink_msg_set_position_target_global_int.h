...
{
    return mavlink_msg_set_position_target_global_int_pack(system_id, component_id, msg, (uint32_t )(set_position_target_global_int->time_boot_ms), (uint8_t )(set_position_target_global_int->target_system), (uint8_t )(set_position_target_global_int->target_component), (uint8_t )(set_position_target_global_int->coordinate_frame), (uint16_t )(set_position_target_global_int->type_mask), (int32_t )(set_position_target_global_int->lat_int), (int32_t )(set_position_target_global_int->lon_int), (float )(set_position_target_global_int->alt), (float )(set_position_target_global_int->vx), (float )(set_position_target_global_int->vy), (float )(set_position_target_global_int->vz), (float )(set_position_target_global_int->afx), (float )(set_position_target_global_int->afy), (float )(set_position_target_global_int->afz), (float )(set_position_target_global_int->yaw), (float )(set_position_target_global_int->yaw_rate));
}
...
{
    return mavlink_msg_set_position_target_global_int_pack_chan(system_id, component_id, chan, msg, (uint32_t )(set_position_target_global_int->time_boot_ms), (uint8_t )(set_position_target_global_int->target_system), (uint8_t )(set_position_target_global_int->target_component), (uint8_t )(set_position_target_global_int->coordinate_frame), (uint16_t )(set_position_target_global_int->type_mask), (int32_t )(set_position_target_global_int->lat_int), (int32_t )(set_position_target_global_int->lon_int), (float )(set_position_target_global_int->alt), (float )(set_position_target_global_int->vx), (float )(set_position_target_global_int->vy), (float )(set_position_target_global_int->vz), (float )(set_position_target_global_int->afx), (float )(set_position_target_global_int->afy), (float )(set_position_target_global_int->afz), (float )(set_position_target_global_int->yaw), (float )(set_position_target_global_int->yaw_rate));
}
