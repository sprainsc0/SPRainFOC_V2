...
{
    return mavlink_msg_position_target_global_int_pack(system_id, component_id, msg, (uint32_t )(position_target_global_int->time_boot_ms), (uint8_t )(position_target_global_int->coordinate_frame), (uint16_t )(position_target_global_int->type_mask), (int32_t )(position_target_global_int->lat_int), (int32_t )(position_target_global_int->lon_int), (float )(position_target_global_int->alt), (float )(position_target_global_int->vx), (float )(position_target_global_int->vy), (float )(position_target_global_int->vz), (float )(position_target_global_int->afx), (float )(position_target_global_int->afy), (float )(position_target_global_int->afz), (float )(position_target_global_int->yaw), (float )(position_target_global_int->yaw_rate));
}
...
{
    return mavlink_msg_position_target_global_int_pack_chan(system_id, component_id, chan, msg, (uint32_t )(position_target_global_int->time_boot_ms), (uint8_t )(position_target_global_int->coordinate_frame), (uint16_t )(position_target_global_int->type_mask), (int32_t )(position_target_global_int->lat_int), (int32_t )(position_target_global_int->lon_int), (float )(position_target_global_int->alt), (float )(position_target_global_int->vx), (float )(position_target_global_int->vy), (float )(position_target_global_int->vz), (float )(position_target_global_int->afx), (float )(position_target_global_int->afy), (float )(position_target_global_int->afz), (float )(position_target_global_int->yaw), (float )(position_target_global_int->yaw_rate));
}
