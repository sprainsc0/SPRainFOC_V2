...
{
    return mavlink_msg_mission_item_reached_pack(system_id, component_id, msg, (uint16_t )(mission_item_reached->seq));
}
...
{
    return mavlink_msg_mission_item_reached_pack_chan(system_id, component_id, chan, msg, (uint16_t )(mission_item_reached->seq));
}
