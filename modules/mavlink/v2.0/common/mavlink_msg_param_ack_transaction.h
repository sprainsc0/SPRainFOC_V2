...
{
    return mavlink_msg_param_ack_transaction_pack(system_id, component_id, msg, (uint8_t )(param_ack_transaction->target_system), (uint8_t )(param_ack_transaction->target_component), (const char *)(param_ack_transaction->param_id), (float )(param_ack_transaction->param_value), (uint8_t )(param_ack_transaction->param_type), (uint8_t )(param_ack_transaction->param_result));
}
...
{
    return mavlink_msg_param_ack_transaction_pack_chan(system_id, component_id, chan, msg, (uint8_t )(param_ack_transaction->target_system), (uint8_t )(param_ack_transaction->target_component), (const char *)(param_ack_transaction->param_id), (float )(param_ack_transaction->param_value), (uint8_t )(param_ack_transaction->param_type), (uint8_t )(param_ack_transaction->param_result));
}
