...
{
    return mavlink_msg_cellular_status_pack(system_id, component_id, msg, (uint8_t )(cellular_status->status), (uint8_t )(cellular_status->failure_reason), (uint8_t )(cellular_status->type), (uint8_t )(cellular_status->quality), (uint16_t )(cellular_status->mcc), (uint16_t )(cellular_status->mnc), (uint16_t )(cellular_status->lac));
}
...
{
    return mavlink_msg_cellular_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(cellular_status->status), (uint8_t )(cellular_status->failure_reason), (uint8_t )(cellular_status->type), (uint8_t )(cellular_status->quality), (uint16_t )(cellular_status->mcc), (uint16_t )(cellular_status->mnc), (uint16_t )(cellular_status->lac));
}
