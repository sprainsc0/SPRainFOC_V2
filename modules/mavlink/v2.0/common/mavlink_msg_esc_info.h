...
{
    return mavlink_msg_esc_info_pack(system_id, component_id, msg, (uint8_t )(esc_info->index), (uint64_t )(esc_info->time_usec), (uint16_t )(esc_info->counter), (uint8_t )(esc_info->count), (uint8_t )(esc_info->connection_type), (uint8_t )(esc_info->info), (const uint16_t *)(esc_info->failure_flags), (const uint32_t *)(esc_info->error_count), (const uint8_t *)(esc_info->temperature));
}
...
{
    return mavlink_msg_esc_info_pack_chan(system_id, component_id, chan, msg, (uint8_t )(esc_info->index), (uint64_t )(esc_info->time_usec), (uint16_t )(esc_info->counter), (uint8_t )(esc_info->count), (uint8_t )(esc_info->connection_type), (uint8_t )(esc_info->info), (const uint16_t *)(esc_info->failure_flags), (const uint32_t *)(esc_info->error_count), (const uint8_t *)(esc_info->temperature));
}
