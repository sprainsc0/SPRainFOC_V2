...
{
    return mavlink_msg_data_transmission_handshake_pack(system_id, component_id, msg, (uint8_t )(data_transmission_handshake->type), (uint32_t )(data_transmission_handshake->size), (uint16_t )(data_transmission_handshake->width), (uint16_t )(data_transmission_handshake->height), (uint16_t )(data_transmission_handshake->packets), (uint8_t )(data_transmission_handshake->payload), (uint8_t )(data_transmission_handshake->jpg_quality));
}
...
{
    return mavlink_msg_data_transmission_handshake_pack_chan(system_id, component_id, chan, msg, (uint8_t )(data_transmission_handshake->type), (uint32_t )(data_transmission_handshake->size), (uint16_t )(data_transmission_handshake->width), (uint16_t )(data_transmission_handshake->height), (uint16_t )(data_transmission_handshake->packets), (uint8_t )(data_transmission_handshake->payload), (uint8_t )(data_transmission_handshake->jpg_quality));
}
