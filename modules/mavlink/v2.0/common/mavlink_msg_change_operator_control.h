...
{
    return mavlink_msg_change_operator_control_pack(system_id, component_id, msg, (uint8_t )(change_operator_control->target_system), (uint8_t )(change_operator_control->control_request), (uint8_t )(change_operator_control->version), (const char *)(change_operator_control->passkey));
}
...
{
    return mavlink_msg_change_operator_control_pack_chan(system_id, component_id, chan, msg, (uint8_t )(change_operator_control->target_system), (uint8_t )(change_operator_control->control_request), (uint8_t )(change_operator_control->version), (const char *)(change_operator_control->passkey));
}
