...
{
    return mavlink_msg_local_position_ned_cov_pack(system_id, component_id, msg, (uint64_t )(local_position_ned_cov->time_usec), (uint8_t )(local_position_ned_cov->estimator_type), (float )(local_position_ned_cov->x), (float )(local_position_ned_cov->y), (float )(local_position_ned_cov->z), (float )(local_position_ned_cov->vx), (float )(local_position_ned_cov->vy), (float )(local_position_ned_cov->vz), (float )(local_position_ned_cov->ax), (float )(local_position_ned_cov->ay), (float )(local_position_ned_cov->az), (const float *)(local_position_ned_cov->covariance));
}
...
{
    return mavlink_msg_local_position_ned_cov_pack_chan(system_id, component_id, chan, msg, (uint64_t )(local_position_ned_cov->time_usec), (uint8_t )(local_position_ned_cov->estimator_type), (float )(local_position_ned_cov->x), (float )(local_position_ned_cov->y), (float )(local_position_ned_cov->z), (float )(local_position_ned_cov->vx), (float )(local_position_ned_cov->vy), (float )(local_position_ned_cov->vz), (float )(local_position_ned_cov->ax), (float )(local_position_ned_cov->ay), (float )(local_position_ned_cov->az), (const float *)(local_position_ned_cov->covariance));
}
