...
{
    return mavlink_msg_gps_status_pack(system_id, component_id, msg, (uint8_t )(gps_status->satellites_visible), (const uint8_t *)(gps_status->satellite_prn), (const uint8_t *)(gps_status->satellite_used), (const uint8_t *)(gps_status->satellite_elevation), (const uint8_t *)(gps_status->satellite_azimuth), (const uint8_t *)(gps_status->satellite_snr));
}
...
{
    return mavlink_msg_gps_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gps_status->satellites_visible), (const uint8_t *)(gps_status->satellite_prn), (const uint8_t *)(gps_status->satellite_used), (const uint8_t *)(gps_status->satellite_elevation), (const uint8_t *)(gps_status->satellite_azimuth), (const uint8_t *)(gps_status->satellite_snr));
}
