...
{
    return mavlink_msg_param_ext_ack_pack(system_id, component_id, msg, (const char *)(param_ext_ack->param_id), (const char *)(param_ext_ack->param_value), (uint8_t )(param_ext_ack->param_type), (uint8_t )(param_ext_ack->param_result));
}
...
{
    return mavlink_msg_param_ext_ack_pack_chan(system_id, component_id, chan, msg, (const char *)(param_ext_ack->param_id), (const char *)(param_ext_ack->param_value), (uint8_t )(param_ext_ack->param_type), (uint8_t )(param_ext_ack->param_result));
}
