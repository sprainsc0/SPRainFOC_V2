...
{
    return mavlink_msg_gps_global_origin_pack(system_id, component_id, msg, (int32_t )(gps_global_origin->latitude), (int32_t )(gps_global_origin->longitude), (int32_t )(gps_global_origin->altitude), (uint64_t )(gps_global_origin->time_usec));
}
...
{
    return mavlink_msg_gps_global_origin_pack_chan(system_id, component_id, chan, msg, (int32_t )(gps_global_origin->latitude), (int32_t )(gps_global_origin->longitude), (int32_t )(gps_global_origin->altitude), (uint64_t )(gps_global_origin->time_usec));
}
