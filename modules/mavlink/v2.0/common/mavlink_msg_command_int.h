...
{
    return mavlink_msg_command_int_pack(system_id, component_id, msg, (uint8_t )(command_int->target_system), (uint8_t )(command_int->target_component), (uint8_t )(command_int->frame), (uint16_t )(command_int->command), (uint8_t )(command_int->current), (uint8_t )(command_int->autocontinue), (float )(command_int->param1), (float )(command_int->param2), (float )(command_int->param3), (float )(command_int->param4), (int32_t )(command_int->x), (int32_t )(command_int->y), (float )(command_int->z));
}
...
{
    return mavlink_msg_command_int_pack_chan(system_id, component_id, chan, msg, (uint8_t )(command_int->target_system), (uint8_t )(command_int->target_component), (uint8_t )(command_int->frame), (uint16_t )(command_int->command), (uint8_t )(command_int->current), (uint8_t )(command_int->autocontinue), (float )(command_int->param1), (float )(command_int->param2), (float )(command_int->param3), (float )(command_int->param4), (int32_t )(command_int->x), (int32_t )(command_int->y), (float )(command_int->z));
}
