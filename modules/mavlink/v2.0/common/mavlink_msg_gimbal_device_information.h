...
{
    return mavlink_msg_gimbal_device_information_pack(system_id, component_id, msg, (uint32_t )(gimbal_device_information->time_boot_ms), (const char *)(gimbal_device_information->vendor_name), (const char *)(gimbal_device_information->model_name), (const char *)(gimbal_device_information->custom_name), (uint32_t )(gimbal_device_information->firmware_version), (uint32_t )(gimbal_device_information->hardware_version), (uint64_t )(gimbal_device_information->uid), (uint16_t )(gimbal_device_information->cap_flags), (uint16_t )(gimbal_device_information->custom_cap_flags), (float )(gimbal_device_information->roll_min), (float )(gimbal_device_information->roll_max), (float )(gimbal_device_information->pitch_min), (float )(gimbal_device_information->pitch_max), (float )(gimbal_device_information->yaw_min), (float )(gimbal_device_information->yaw_max));
}
...
{
    return mavlink_msg_gimbal_device_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(gimbal_device_information->time_boot_ms), (const char *)(gimbal_device_information->vendor_name), (const char *)(gimbal_device_information->model_name), (const char *)(gimbal_device_information->custom_name), (uint32_t )(gimbal_device_information->firmware_version), (uint32_t )(gimbal_device_information->hardware_version), (uint64_t )(gimbal_device_information->uid), (uint16_t )(gimbal_device_information->cap_flags), (uint16_t )(gimbal_device_information->custom_cap_flags), (float )(gimbal_device_information->roll_min), (float )(gimbal_device_information->roll_max), (float )(gimbal_device_information->pitch_min), (float )(gimbal_device_information->pitch_max), (float )(gimbal_device_information->yaw_min), (float )(gimbal_device_information->yaw_max));
}
