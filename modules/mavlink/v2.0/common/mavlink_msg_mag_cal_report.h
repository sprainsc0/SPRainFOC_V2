...
{
    return mavlink_msg_mag_cal_report_pack(system_id, component_id, msg, (uint8_t )(mag_cal_report->compass_id), (uint8_t )(mag_cal_report->cal_mask), (uint8_t )(mag_cal_report->cal_status), (uint8_t )(mag_cal_report->autosaved), (float )(mag_cal_report->fitness), (float )(mag_cal_report->ofs_x), (float )(mag_cal_report->ofs_y), (float )(mag_cal_report->ofs_z), (float )(mag_cal_report->diag_x), (float )(mag_cal_report->diag_y), (float )(mag_cal_report->diag_z), (float )(mag_cal_report->offdiag_x), (float )(mag_cal_report->offdiag_y), (float )(mag_cal_report->offdiag_z), (float )(mag_cal_report->orientation_confidence), (uint8_t )(mag_cal_report->old_orientation), (uint8_t )(mag_cal_report->new_orientation), (float )(mag_cal_report->scale_factor));
}
...
{
    return mavlink_msg_mag_cal_report_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mag_cal_report->compass_id), (uint8_t )(mag_cal_report->cal_mask), (uint8_t )(mag_cal_report->cal_status), (uint8_t )(mag_cal_report->autosaved), (float )(mag_cal_report->fitness), (float )(mag_cal_report->ofs_x), (float )(mag_cal_report->ofs_y), (float )(mag_cal_report->ofs_z), (float )(mag_cal_report->diag_x), (float )(mag_cal_report->diag_y), (float )(mag_cal_report->diag_z), (float )(mag_cal_report->offdiag_x), (float )(mag_cal_report->offdiag_y), (float )(mag_cal_report->offdiag_z), (float )(mag_cal_report->orientation_confidence), (uint8_t )(mag_cal_report->old_orientation), (uint8_t )(mag_cal_report->new_orientation), (float )(mag_cal_report->scale_factor));
}
