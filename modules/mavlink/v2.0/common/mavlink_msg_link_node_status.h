...
{
    return mavlink_msg_link_node_status_pack(system_id, component_id, msg, (uint64_t )(link_node_status->timestamp), (uint8_t )(link_node_status->tx_buf), (uint8_t )(link_node_status->rx_buf), (uint32_t )(link_node_status->tx_rate), (uint32_t )(link_node_status->rx_rate), (uint16_t )(link_node_status->rx_parse_err), (uint16_t )(link_node_status->tx_overflows), (uint16_t )(link_node_status->rx_overflows), (uint32_t )(link_node_status->messages_sent), (uint32_t )(link_node_status->messages_received), (uint32_t )(link_node_status->messages_lost));
}
...
{
    return mavlink_msg_link_node_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(link_node_status->timestamp), (uint8_t )(link_node_status->tx_buf), (uint8_t )(link_node_status->rx_buf), (uint32_t )(link_node_status->tx_rate), (uint32_t )(link_node_status->rx_rate), (uint16_t )(link_node_status->rx_parse_err), (uint16_t )(link_node_status->tx_overflows), (uint16_t )(link_node_status->rx_overflows), (uint32_t )(link_node_status->messages_sent), (uint32_t )(link_node_status->messages_received), (uint32_t )(link_node_status->messages_lost));
}
