...
{
    return mavlink_msg_estimator_status_pack(system_id, component_id, msg, (uint64_t )(estimator_status->time_usec), (uint16_t )(estimator_status->flags), (float )(estimator_status->vel_ratio), (float )(estimator_status->pos_horiz_ratio), (float )(estimator_status->pos_vert_ratio), (float )(estimator_status->mag_ratio), (float )(estimator_status->hagl_ratio), (float )(estimator_status->tas_ratio), (float )(estimator_status->pos_horiz_accuracy), (float )(estimator_status->pos_vert_accuracy));
}
...
{
    return mavlink_msg_estimator_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(estimator_status->time_usec), (uint16_t )(estimator_status->flags), (float )(estimator_status->vel_ratio), (float )(estimator_status->pos_horiz_ratio), (float )(estimator_status->pos_vert_ratio), (float )(estimator_status->mag_ratio), (float )(estimator_status->hagl_ratio), (float )(estimator_status->tas_ratio), (float )(estimator_status->pos_horiz_accuracy), (float )(estimator_status->pos_vert_accuracy));
}
