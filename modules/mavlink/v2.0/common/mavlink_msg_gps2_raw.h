...
{
    return mavlink_msg_gps2_raw_pack(system_id, component_id, msg, (uint64_t )(gps2_raw->time_usec), (uint8_t )(gps2_raw->fix_type), (int32_t )(gps2_raw->lat), (int32_t )(gps2_raw->lon), (int32_t )(gps2_raw->alt), (uint16_t )(gps2_raw->eph), (uint16_t )(gps2_raw->epv), (uint16_t )(gps2_raw->vel), (uint16_t )(gps2_raw->cog), (uint8_t )(gps2_raw->satellites_visible), (uint8_t )(gps2_raw->dgps_numch), (uint32_t )(gps2_raw->dgps_age), (uint16_t )(gps2_raw->yaw));
}
...
{
    return mavlink_msg_gps2_raw_pack_chan(system_id, component_id, chan, msg, (uint64_t )(gps2_raw->time_usec), (uint8_t )(gps2_raw->fix_type), (int32_t )(gps2_raw->lat), (int32_t )(gps2_raw->lon), (int32_t )(gps2_raw->alt), (uint16_t )(gps2_raw->eph), (uint16_t )(gps2_raw->epv), (uint16_t )(gps2_raw->vel), (uint16_t )(gps2_raw->cog), (uint8_t )(gps2_raw->satellites_visible), (uint8_t )(gps2_raw->dgps_numch), (uint32_t )(gps2_raw->dgps_age), (uint16_t )(gps2_raw->yaw));
}
