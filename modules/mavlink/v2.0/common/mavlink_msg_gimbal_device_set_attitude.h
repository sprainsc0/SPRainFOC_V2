...
{
    return mavlink_msg_gimbal_device_set_attitude_pack(system_id, component_id, msg, (uint8_t )(gimbal_device_set_attitude->target_system), (uint8_t )(gimbal_device_set_attitude->target_component), (uint16_t )(gimbal_device_set_attitude->flags), (const float *)(gimbal_device_set_attitude->q), (float )(gimbal_device_set_attitude->angular_velocity_x), (float )(gimbal_device_set_attitude->angular_velocity_y), (float )(gimbal_device_set_attitude->angular_velocity_z));
}
...
{
    return mavlink_msg_gimbal_device_set_attitude_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gimbal_device_set_attitude->target_system), (uint8_t )(gimbal_device_set_attitude->target_component), (uint16_t )(gimbal_device_set_attitude->flags), (const float *)(gimbal_device_set_attitude->q), (float )(gimbal_device_set_attitude->angular_velocity_x), (float )(gimbal_device_set_attitude->angular_velocity_y), (float )(gimbal_device_set_attitude->angular_velocity_z));
}
