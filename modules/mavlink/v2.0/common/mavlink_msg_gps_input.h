...
{
    return mavlink_msg_gps_input_pack(system_id, component_id, msg, (uint64_t )(gps_input->time_usec), (uint8_t )(gps_input->gps_id), (uint16_t )(gps_input->ignore_flags), (uint32_t )(gps_input->time_week_ms), (uint16_t )(gps_input->time_week), (uint8_t )(gps_input->fix_type), (int32_t )(gps_input->lat), (int32_t )(gps_input->lon), (float )(gps_input->alt), (float )(gps_input->hdop), (float )(gps_input->vdop), (float )(gps_input->vn), (float )(gps_input->ve), (float )(gps_input->vd), (float )(gps_input->speed_accuracy), (float )(gps_input->horiz_accuracy), (float )(gps_input->vert_accuracy), (uint8_t )(gps_input->satellites_visible), (uint16_t )(gps_input->yaw));
}
...
{
    return mavlink_msg_gps_input_pack_chan(system_id, component_id, chan, msg, (uint64_t )(gps_input->time_usec), (uint8_t )(gps_input->gps_id), (uint16_t )(gps_input->ignore_flags), (uint32_t )(gps_input->time_week_ms), (uint16_t )(gps_input->time_week), (uint8_t )(gps_input->fix_type), (int32_t )(gps_input->lat), (int32_t )(gps_input->lon), (float )(gps_input->alt), (float )(gps_input->hdop), (float )(gps_input->vdop), (float )(gps_input->vn), (float )(gps_input->ve), (float )(gps_input->vd), (float )(gps_input->speed_accuracy), (float )(gps_input->horiz_accuracy), (float )(gps_input->vert_accuracy), (uint8_t )(gps_input->satellites_visible), (uint16_t )(gps_input->yaw));
}
