...
{
    return mavlink_msg_local_position_ned_system_global_offset_pack(system_id, component_id, msg, (uint32_t )(local_position_ned_system_global_offset->time_boot_ms), (float )(local_position_ned_system_global_offset->x), (float )(local_position_ned_system_global_offset->y), (float )(local_position_ned_system_global_offset->z), (float )(local_position_ned_system_global_offset->roll), (float )(local_position_ned_system_global_offset->pitch), (float )(local_position_ned_system_global_offset->yaw));
}
...
{
    return mavlink_msg_local_position_ned_system_global_offset_pack_chan(system_id, component_id, chan, msg, (uint32_t )(local_position_ned_system_global_offset->time_boot_ms), (float )(local_position_ned_system_global_offset->x), (float )(local_position_ned_system_global_offset->y), (float )(local_position_ned_system_global_offset->z), (float )(local_position_ned_system_global_offset->roll), (float )(local_position_ned_system_global_offset->pitch), (float )(local_position_ned_system_global_offset->yaw));
}
