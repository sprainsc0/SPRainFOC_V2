...
{
    return mavlink_msg_odometry_pack(system_id, component_id, msg, (uint64_t )(odometry->time_usec), (uint8_t )(odometry->frame_id), (uint8_t )(odometry->child_frame_id), (float )(odometry->x), (float )(odometry->y), (float )(odometry->z), (const float *)(odometry->q), (float )(odometry->vx), (float )(odometry->vy), (float )(odometry->vz), (float )(odometry->rollspeed), (float )(odometry->pitchspeed), (float )(odometry->yawspeed), (const float *)(odometry->pose_covariance), (const float *)(odometry->velocity_covariance), (uint8_t )(odometry->reset_counter), (uint8_t )(odometry->estimator_type));
}
...
{
    return mavlink_msg_odometry_pack_chan(system_id, component_id, chan, msg, (uint64_t )(odometry->time_usec), (uint8_t )(odometry->frame_id), (uint8_t )(odometry->child_frame_id), (float )(odometry->x), (float )(odometry->y), (float )(odometry->z), (const float *)(odometry->q), (float )(odometry->vx), (float )(odometry->vy), (float )(odometry->vz), (float )(odometry->rollspeed), (float )(odometry->pitchspeed), (float )(odometry->yawspeed), (const float *)(odometry->pose_covariance), (const float *)(odometry->velocity_covariance), (uint8_t )(odometry->reset_counter), (uint8_t )(odometry->estimator_type));
}
