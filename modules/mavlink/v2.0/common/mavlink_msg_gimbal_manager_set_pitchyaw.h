...
{
    return mavlink_msg_gimbal_manager_set_pitchyaw_pack(system_id, component_id, msg, (uint8_t )(gimbal_manager_set_pitchyaw->target_system), (uint8_t )(gimbal_manager_set_pitchyaw->target_component), (uint32_t )(gimbal_manager_set_pitchyaw->flags), (uint8_t )(gimbal_manager_set_pitchyaw->gimbal_device_id), (float )(gimbal_manager_set_pitchyaw->pitch), (float )(gimbal_manager_set_pitchyaw->yaw), (float )(gimbal_manager_set_pitchyaw->pitch_rate), (float )(gimbal_manager_set_pitchyaw->yaw_rate));
}
...
{
    return mavlink_msg_gimbal_manager_set_pitchyaw_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gimbal_manager_set_pitchyaw->target_system), (uint8_t )(gimbal_manager_set_pitchyaw->target_component), (uint32_t )(gimbal_manager_set_pitchyaw->flags), (uint8_t )(gimbal_manager_set_pitchyaw->gimbal_device_id), (float )(gimbal_manager_set_pitchyaw->pitch), (float )(gimbal_manager_set_pitchyaw->yaw), (float )(gimbal_manager_set_pitchyaw->pitch_rate), (float )(gimbal_manager_set_pitchyaw->yaw_rate));
}
