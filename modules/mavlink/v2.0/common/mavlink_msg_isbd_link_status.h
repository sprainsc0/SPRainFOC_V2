...
{
    return mavlink_msg_isbd_link_status_pack(system_id, component_id, msg, (uint64_t )(isbd_link_status->timestamp), (uint64_t )(isbd_link_status->last_heartbeat), (uint16_t )(isbd_link_status->failed_sessions), (uint16_t )(isbd_link_status->successful_sessions), (uint8_t )(isbd_link_status->signal_quality), (uint8_t )(isbd_link_status->ring_pending), (uint8_t )(isbd_link_status->tx_session_pending), (uint8_t )(isbd_link_status->rx_session_pending));
}
...
{
    return mavlink_msg_isbd_link_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(isbd_link_status->timestamp), (uint64_t )(isbd_link_status->last_heartbeat), (uint16_t )(isbd_link_status->failed_sessions), (uint16_t )(isbd_link_status->successful_sessions), (uint8_t )(isbd_link_status->signal_quality), (uint8_t )(isbd_link_status->ring_pending), (uint8_t )(isbd_link_status->tx_session_pending), (uint8_t )(isbd_link_status->rx_session_pending));
}
