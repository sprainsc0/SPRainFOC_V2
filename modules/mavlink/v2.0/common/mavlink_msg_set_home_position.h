...
{
    return mavlink_msg_set_home_position_pack(system_id, component_id, msg, (uint8_t )(set_home_position->target_system), (int32_t )(set_home_position->latitude), (int32_t )(set_home_position->longitude), (int32_t )(set_home_position->altitude), (float )(set_home_position->x), (float )(set_home_position->y), (float )(set_home_position->z), (const float *)(set_home_position->q), (float )(set_home_position->approach_x), (float )(set_home_position->approach_y), (float )(set_home_position->approach_z), (uint64_t )(set_home_position->time_usec));
}
...
{
    return mavlink_msg_set_home_position_pack_chan(system_id, component_id, chan, msg, (uint8_t )(set_home_position->target_system), (int32_t )(set_home_position->latitude), (int32_t )(set_home_position->longitude), (int32_t )(set_home_position->altitude), (float )(set_home_position->x), (float )(set_home_position->y), (float )(set_home_position->z), (const float *)(set_home_position->q), (float )(set_home_position->approach_x), (float )(set_home_position->approach_y), (float )(set_home_position->approach_z), (uint64_t )(set_home_position->time_usec));
}
