...
{
    return mavlink_msg_gimbal_manager_status_pack(system_id, component_id, msg, (uint32_t )(gimbal_manager_status->time_boot_ms), (uint32_t )(gimbal_manager_status->flags), (uint8_t )(gimbal_manager_status->gimbal_device_id), (uint8_t )(gimbal_manager_status->primary_control_sysid), (uint8_t )(gimbal_manager_status->primary_control_compid), (uint8_t )(gimbal_manager_status->secondary_control_sysid), (uint8_t )(gimbal_manager_status->secondary_control_compid));
}
...
{
    return mavlink_msg_gimbal_manager_status_pack_chan(system_id, component_id, chan, msg, (uint32_t )(gimbal_manager_status->time_boot_ms), (uint32_t )(gimbal_manager_status->flags), (uint8_t )(gimbal_manager_status->gimbal_device_id), (uint8_t )(gimbal_manager_status->primary_control_sysid), (uint8_t )(gimbal_manager_status->primary_control_compid), (uint8_t )(gimbal_manager_status->secondary_control_sysid), (uint8_t )(gimbal_manager_status->secondary_control_compid));
}
