...
{
    return mavlink_msg_onboard_computer_status_pack(system_id, component_id, msg, (uint64_t )(onboard_computer_status->time_usec), (uint32_t )(onboard_computer_status->uptime), (uint8_t )(onboard_computer_status->type), (const uint8_t *)(onboard_computer_status->cpu_cores), (const uint8_t *)(onboard_computer_status->cpu_combined), (const uint8_t *)(onboard_computer_status->gpu_cores), (const uint8_t *)(onboard_computer_status->gpu_combined), (int8_t )(onboard_computer_status->temperature_board), (const int8_t *)(onboard_computer_status->temperature_core), (const int16_t *)(onboard_computer_status->fan_speed), (uint32_t )(onboard_computer_status->ram_usage), (uint32_t )(onboard_computer_status->ram_total), (const uint32_t *)(onboard_computer_status->storage_type), (const uint32_t *)(onboard_computer_status->storage_usage), (const uint32_t *)(onboard_computer_status->storage_total), (const uint32_t *)(onboard_computer_status->link_type), (const uint32_t *)(onboard_computer_status->link_tx_rate), (const uint32_t *)(onboard_computer_status->link_rx_rate), (const uint32_t *)(onboard_computer_status->link_tx_max), (const uint32_t *)(onboard_computer_status->link_rx_max));
}
...
{
    return mavlink_msg_onboard_computer_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(onboard_computer_status->time_usec), (uint32_t )(onboard_computer_status->uptime), (uint8_t )(onboard_computer_status->type), (const uint8_t *)(onboard_computer_status->cpu_cores), (const uint8_t *)(onboard_computer_status->cpu_combined), (const uint8_t *)(onboard_computer_status->gpu_cores), (const uint8_t *)(onboard_computer_status->gpu_combined), (int8_t )(onboard_computer_status->temperature_board), (const int8_t *)(onboard_computer_status->temperature_core), (const int16_t *)(onboard_computer_status->fan_speed), (uint32_t )(onboard_computer_status->ram_usage), (uint32_t )(onboard_computer_status->ram_total), (const uint32_t *)(onboard_computer_status->storage_type), (const uint32_t *)(onboard_computer_status->storage_usage), (const uint32_t *)(onboard_computer_status->storage_total), (const uint32_t *)(onboard_computer_status->link_type), (const uint32_t *)(onboard_computer_status->link_tx_rate), (const uint32_t *)(onboard_computer_status->link_rx_rate), (const uint32_t *)(onboard_computer_status->link_tx_max), (const uint32_t *)(onboard_computer_status->link_rx_max));
}
