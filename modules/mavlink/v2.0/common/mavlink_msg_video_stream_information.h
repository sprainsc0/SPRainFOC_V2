...
{
    return mavlink_msg_video_stream_information_pack(system_id, component_id, msg, (uint8_t )(video_stream_information->stream_id), (uint8_t )(video_stream_information->count), (uint8_t )(video_stream_information->type), (uint16_t )(video_stream_information->flags), (float )(video_stream_information->framerate), (uint16_t )(video_stream_information->resolution_h), (uint16_t )(video_stream_information->resolution_v), (uint32_t )(video_stream_information->bitrate), (uint16_t )(video_stream_information->rotation), (uint16_t )(video_stream_information->hfov), (const char *)(video_stream_information->name), (const char *)(video_stream_information->uri));
}
...
{
    return mavlink_msg_video_stream_information_pack_chan(system_id, component_id, chan, msg, (uint8_t )(video_stream_information->stream_id), (uint8_t )(video_stream_information->count), (uint8_t )(video_stream_information->type), (uint16_t )(video_stream_information->flags), (float )(video_stream_information->framerate), (uint16_t )(video_stream_information->resolution_h), (uint16_t )(video_stream_information->resolution_v), (uint32_t )(video_stream_information->bitrate), (uint16_t )(video_stream_information->rotation), (uint16_t )(video_stream_information->hfov), (const char *)(video_stream_information->name), (const char *)(video_stream_information->uri));
}
