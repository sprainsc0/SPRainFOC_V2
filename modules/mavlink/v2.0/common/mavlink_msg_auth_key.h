...
{
    return mavlink_msg_auth_key_pack(system_id, component_id, msg, (const char *)(auth_key->key));
}
...
{
    return mavlink_msg_auth_key_pack_chan(system_id, component_id, chan, msg, (const char *)(auth_key->key));
}
