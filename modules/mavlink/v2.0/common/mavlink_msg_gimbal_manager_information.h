...
{
    return mavlink_msg_gimbal_manager_information_pack(system_id, component_id, msg, (uint32_t )(gimbal_manager_information->time_boot_ms), (uint32_t )(gimbal_manager_information->cap_flags), (uint8_t )(gimbal_manager_information->gimbal_device_id), (float )(gimbal_manager_information->roll_min), (float )(gimbal_manager_information->roll_max), (float )(gimbal_manager_information->pitch_min), (float )(gimbal_manager_information->pitch_max), (float )(gimbal_manager_information->yaw_min), (float )(gimbal_manager_information->yaw_max));
}
...
{
    return mavlink_msg_gimbal_manager_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(gimbal_manager_information->time_boot_ms), (uint32_t )(gimbal_manager_information->cap_flags), (uint8_t )(gimbal_manager_information->gimbal_device_id), (float )(gimbal_manager_information->roll_min), (float )(gimbal_manager_information->roll_max), (float )(gimbal_manager_information->pitch_min), (float )(gimbal_manager_information->pitch_max), (float )(gimbal_manager_information->yaw_min), (float )(gimbal_manager_information->yaw_max));
}
