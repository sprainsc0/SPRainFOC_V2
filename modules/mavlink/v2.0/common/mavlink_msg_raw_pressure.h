...
{
    return mavlink_msg_raw_pressure_pack(system_id, component_id, msg, (uint64_t )(raw_pressure->time_usec), (int16_t )(raw_pressure->press_abs), (int16_t )(raw_pressure->press_diff1), (int16_t )(raw_pressure->press_diff2), (int16_t )(raw_pressure->temperature));
}
...
{
    return mavlink_msg_raw_pressure_pack_chan(system_id, component_id, chan, msg, (uint64_t )(raw_pressure->time_usec), (int16_t )(raw_pressure->press_abs), (int16_t )(raw_pressure->press_diff1), (int16_t )(raw_pressure->press_diff2), (int16_t )(raw_pressure->temperature));
}
