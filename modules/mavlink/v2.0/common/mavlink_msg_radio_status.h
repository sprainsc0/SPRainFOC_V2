...
{
    return mavlink_msg_radio_status_pack(system_id, component_id, msg, (uint8_t )(radio_status->rssi), (uint8_t )(radio_status->remrssi), (uint8_t )(radio_status->txbuf), (uint8_t )(radio_status->noise), (uint8_t )(radio_status->remnoise), (uint16_t )(radio_status->rxerrors), (uint16_t )(radio_status->fixed));
}
...
{
    return mavlink_msg_radio_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(radio_status->rssi), (uint8_t )(radio_status->remrssi), (uint8_t )(radio_status->txbuf), (uint8_t )(radio_status->noise), (uint8_t )(radio_status->remnoise), (uint16_t )(radio_status->rxerrors), (uint16_t )(radio_status->fixed));
}
