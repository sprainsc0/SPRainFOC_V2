...
{
    return mavlink_msg_attitude_quaternion_cov_pack(system_id, component_id, msg, (uint64_t )(attitude_quaternion_cov->time_usec), (const float *)(attitude_quaternion_cov->q), (float )(attitude_quaternion_cov->rollspeed), (float )(attitude_quaternion_cov->pitchspeed), (float )(attitude_quaternion_cov->yawspeed), (const float *)(attitude_quaternion_cov->covariance));
}
...
{
    return mavlink_msg_attitude_quaternion_cov_pack_chan(system_id, component_id, chan, msg, (uint64_t )(attitude_quaternion_cov->time_usec), (const float *)(attitude_quaternion_cov->q), (float )(attitude_quaternion_cov->rollspeed), (float )(attitude_quaternion_cov->pitchspeed), (float )(attitude_quaternion_cov->yawspeed), (const float *)(attitude_quaternion_cov->covariance));
}
