...
{
    return mavlink_msg_rc_channels_scaled_pack(system_id, component_id, msg, (uint32_t )(rc_channels_scaled->time_boot_ms), (uint8_t )(rc_channels_scaled->port), (int16_t )(rc_channels_scaled->chan1_scaled), (int16_t )(rc_channels_scaled->chan2_scaled), (int16_t )(rc_channels_scaled->chan3_scaled), (int16_t )(rc_channels_scaled->chan4_scaled), (int16_t )(rc_channels_scaled->chan5_scaled), (int16_t )(rc_channels_scaled->chan6_scaled), (int16_t )(rc_channels_scaled->chan7_scaled), (int16_t )(rc_channels_scaled->chan8_scaled), (uint8_t )(rc_channels_scaled->rssi));
}
...
{
    return mavlink_msg_rc_channels_scaled_pack_chan(system_id, component_id, chan, msg, (uint32_t )(rc_channels_scaled->time_boot_ms), (uint8_t )(rc_channels_scaled->port), (int16_t )(rc_channels_scaled->chan1_scaled), (int16_t )(rc_channels_scaled->chan2_scaled), (int16_t )(rc_channels_scaled->chan3_scaled), (int16_t )(rc_channels_scaled->chan4_scaled), (int16_t )(rc_channels_scaled->chan5_scaled), (int16_t )(rc_channels_scaled->chan6_scaled), (int16_t )(rc_channels_scaled->chan7_scaled), (int16_t )(rc_channels_scaled->chan8_scaled), (uint8_t )(rc_channels_scaled->rssi));
}
