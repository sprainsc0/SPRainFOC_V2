...
{
    return mavlink_msg_serial_control_pack(system_id, component_id, msg, (uint8_t )(serial_control->device), (uint8_t )(serial_control->flags), (uint16_t )(serial_control->timeout), (uint32_t )(serial_control->baudrate), (uint8_t )(serial_control->count), (const uint8_t *)(serial_control->data));
}
...
{
    return mavlink_msg_serial_control_pack_chan(system_id, component_id, chan, msg, (uint8_t )(serial_control->device), (uint8_t )(serial_control->flags), (uint16_t )(serial_control->timeout), (uint32_t )(serial_control->baudrate), (uint8_t )(serial_control->count), (const uint8_t *)(serial_control->data));
}
