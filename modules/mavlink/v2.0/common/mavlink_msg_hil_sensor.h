...
{
    return mavlink_msg_hil_sensor_pack(system_id, component_id, msg, (uint64_t )(hil_sensor->time_usec), (float )(hil_sensor->xacc), (float )(hil_sensor->yacc), (float )(hil_sensor->zacc), (float )(hil_sensor->xgyro), (float )(hil_sensor->ygyro), (float )(hil_sensor->zgyro), (float )(hil_sensor->xmag), (float )(hil_sensor->ymag), (float )(hil_sensor->zmag), (float )(hil_sensor->abs_pressure), (float )(hil_sensor->diff_pressure), (float )(hil_sensor->pressure_alt), (float )(hil_sensor->temperature), (uint32_t )(hil_sensor->fields_updated), (uint8_t )(hil_sensor->id));
}
...
{
    return mavlink_msg_hil_sensor_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_sensor->time_usec), (float )(hil_sensor->xacc), (float )(hil_sensor->yacc), (float )(hil_sensor->zacc), (float )(hil_sensor->xgyro), (float )(hil_sensor->ygyro), (float )(hil_sensor->zgyro), (float )(hil_sensor->xmag), (float )(hil_sensor->ymag), (float )(hil_sensor->zmag), (float )(hil_sensor->abs_pressure), (float )(hil_sensor->diff_pressure), (float )(hil_sensor->pressure_alt), (float )(hil_sensor->temperature), (uint32_t )(hil_sensor->fields_updated), (uint8_t )(hil_sensor->id));
}
