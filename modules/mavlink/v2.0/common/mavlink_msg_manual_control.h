...
{
    return mavlink_msg_manual_control_pack(system_id, component_id, msg, (uint8_t )(manual_control->target), (int16_t )(manual_control->x), (int16_t )(manual_control->y), (int16_t )(manual_control->z), (int16_t )(manual_control->r), (uint16_t )(manual_control->buttons));
}
...
{
    return mavlink_msg_manual_control_pack_chan(system_id, component_id, chan, msg, (uint8_t )(manual_control->target), (int16_t )(manual_control->x), (int16_t )(manual_control->y), (int16_t )(manual_control->z), (int16_t )(manual_control->r), (uint16_t )(manual_control->buttons));
}
