...
{
    return mavlink_msg_terrain_check_pack(system_id, component_id, msg, (int32_t )(terrain_check->lat), (int32_t )(terrain_check->lon));
}
...
{
    return mavlink_msg_terrain_check_pack_chan(system_id, component_id, chan, msg, (int32_t )(terrain_check->lat), (int32_t )(terrain_check->lon));
}
