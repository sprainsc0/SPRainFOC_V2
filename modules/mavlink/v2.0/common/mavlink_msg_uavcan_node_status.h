...
{
    return mavlink_msg_uavcan_node_status_pack(system_id, component_id, msg, (uint64_t )(uavcan_node_status->time_usec), (uint32_t )(uavcan_node_status->uptime_sec), (uint8_t )(uavcan_node_status->health), (uint8_t )(uavcan_node_status->mode), (uint8_t )(uavcan_node_status->sub_mode), (uint16_t )(uavcan_node_status->vendor_specific_status_code));
}
...
{
    return mavlink_msg_uavcan_node_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(uavcan_node_status->time_usec), (uint32_t )(uavcan_node_status->uptime_sec), (uint8_t )(uavcan_node_status->health), (uint8_t )(uavcan_node_status->mode), (uint8_t )(uavcan_node_status->sub_mode), (uint16_t )(uavcan_node_status->vendor_specific_status_code));
}
