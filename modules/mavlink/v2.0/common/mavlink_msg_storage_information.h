...
{
    return mavlink_msg_storage_information_pack(system_id, component_id, msg, (uint32_t )(storage_information->time_boot_ms), (uint8_t )(storage_information->storage_id), (uint8_t )(storage_information->storage_count), (uint8_t )(storage_information->status), (float )(storage_information->total_capacity), (float )(storage_information->used_capacity), (float )(storage_information->available_capacity), (float )(storage_information->read_speed), (float )(storage_information->write_speed), (uint8_t )(storage_information->type), (const char *)(storage_information->name));
}
...
{
    return mavlink_msg_storage_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(storage_information->time_boot_ms), (uint8_t )(storage_information->storage_id), (uint8_t )(storage_information->storage_count), (uint8_t )(storage_information->status), (float )(storage_information->total_capacity), (float )(storage_information->used_capacity), (float )(storage_information->available_capacity), (float )(storage_information->read_speed), (float )(storage_information->write_speed), (uint8_t )(storage_information->type), (const char *)(storage_information->name));
}
