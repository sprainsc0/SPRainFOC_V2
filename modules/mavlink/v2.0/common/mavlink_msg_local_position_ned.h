...
{
    return mavlink_msg_local_position_ned_pack(system_id, component_id, msg, (uint32_t )(local_position_ned->time_boot_ms), (float )(local_position_ned->x), (float )(local_position_ned->y), (float )(local_position_ned->z), (float )(local_position_ned->vx), (float )(local_position_ned->vy), (float )(local_position_ned->vz));
}
...
{
    return mavlink_msg_local_position_ned_pack_chan(system_id, component_id, chan, msg, (uint32_t )(local_position_ned->time_boot_ms), (float )(local_position_ned->x), (float )(local_position_ned->y), (float )(local_position_ned->z), (float )(local_position_ned->vx), (float )(local_position_ned->vy), (float )(local_position_ned->vz));
}
