...
{
    return mavlink_msg_mission_ack_pack(system_id, component_id, msg, (uint8_t )(mission_ack->target_system), (uint8_t )(mission_ack->target_component), (uint8_t )(mission_ack->type), (uint8_t )(mission_ack->mission_type));
}
...
{
    return mavlink_msg_mission_ack_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_ack->target_system), (uint8_t )(mission_ack->target_component), (uint8_t )(mission_ack->type), (uint8_t )(mission_ack->mission_type));
}
