...
{
    return mavlink_msg_trajectory_representation_bezier_pack(system_id, component_id, msg, (uint64_t )(trajectory_representation_bezier->time_usec), (uint8_t )(trajectory_representation_bezier->valid_points), (const float *)(trajectory_representation_bezier->pos_x), (const float *)(trajectory_representation_bezier->pos_y), (const float *)(trajectory_representation_bezier->pos_z), (const float *)(trajectory_representation_bezier->delta), (const float *)(trajectory_representation_bezier->pos_yaw));
}
...
{
    return mavlink_msg_trajectory_representation_bezier_pack_chan(system_id, component_id, chan, msg, (uint64_t )(trajectory_representation_bezier->time_usec), (uint8_t )(trajectory_representation_bezier->valid_points), (const float *)(trajectory_representation_bezier->pos_x), (const float *)(trajectory_representation_bezier->pos_y), (const float *)(trajectory_representation_bezier->pos_z), (const float *)(trajectory_representation_bezier->delta), (const float *)(trajectory_representation_bezier->pos_yaw));
}
