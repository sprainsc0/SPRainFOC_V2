...
{
    return mavlink_msg_hil_controls_pack(system_id, component_id, msg, (uint64_t )(hil_controls->time_usec), (float )(hil_controls->roll_ailerons), (float )(hil_controls->pitch_elevator), (float )(hil_controls->yaw_rudder), (float )(hil_controls->throttle), (float )(hil_controls->aux1), (float )(hil_controls->aux2), (float )(hil_controls->aux3), (float )(hil_controls->aux4), (uint8_t )(hil_controls->mode), (uint8_t )(hil_controls->nav_mode));
}
...
{
    return mavlink_msg_hil_controls_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_controls->time_usec), (float )(hil_controls->roll_ailerons), (float )(hil_controls->pitch_elevator), (float )(hil_controls->yaw_rudder), (float )(hil_controls->throttle), (float )(hil_controls->aux1), (float )(hil_controls->aux2), (float )(hil_controls->aux3), (float )(hil_controls->aux4), (uint8_t )(hil_controls->mode), (uint8_t )(hil_controls->nav_mode));
}
