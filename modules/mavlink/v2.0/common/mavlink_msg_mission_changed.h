...
{
    return mavlink_msg_mission_changed_pack(system_id, component_id, msg, (int16_t )(mission_changed->start_index), (int16_t )(mission_changed->end_index), (uint8_t )(mission_changed->origin_sysid), (uint8_t )(mission_changed->origin_compid), (uint8_t )(mission_changed->mission_type));
}
...
{
    return mavlink_msg_mission_changed_pack_chan(system_id, component_id, chan, msg, (int16_t )(mission_changed->start_index), (int16_t )(mission_changed->end_index), (uint8_t )(mission_changed->origin_sysid), (uint8_t )(mission_changed->origin_compid), (uint8_t )(mission_changed->mission_type));
}
