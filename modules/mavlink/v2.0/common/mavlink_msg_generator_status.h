...
{
    return mavlink_msg_generator_status_pack(system_id, component_id, msg, (uint64_t )(generator_status->status), (uint16_t )(generator_status->generator_speed), (float )(generator_status->battery_current), (float )(generator_status->load_current), (float )(generator_status->power_generated), (float )(generator_status->bus_voltage), (int16_t )(generator_status->rectifier_temperature), (float )(generator_status->bat_current_setpoint), (int16_t )(generator_status->generator_temperature), (uint32_t )(generator_status->runtime), (int32_t )(generator_status->time_until_maintenance));
}
...
{
    return mavlink_msg_generator_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(generator_status->status), (uint16_t )(generator_status->generator_speed), (float )(generator_status->battery_current), (float )(generator_status->load_current), (float )(generator_status->power_generated), (float )(generator_status->bus_voltage), (int16_t )(generator_status->rectifier_temperature), (float )(generator_status->bat_current_setpoint), (int16_t )(generator_status->generator_temperature), (uint32_t )(generator_status->runtime), (int32_t )(generator_status->time_until_maintenance));
}
