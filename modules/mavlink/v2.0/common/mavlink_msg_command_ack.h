...
{
    return mavlink_msg_command_ack_pack(system_id, component_id, msg, (uint16_t )(command_ack->command), (uint8_t )(command_ack->result), (uint8_t )(command_ack->progress), (int32_t )(command_ack->result_param2), (uint8_t )(command_ack->target_system), (uint8_t )(command_ack->target_component));
}
...
{
    return mavlink_msg_command_ack_pack_chan(system_id, component_id, chan, msg, (uint16_t )(command_ack->command), (uint8_t )(command_ack->result), (uint8_t )(command_ack->progress), (int32_t )(command_ack->result_param2), (uint8_t )(command_ack->target_system), (uint8_t )(command_ack->target_component));
}
