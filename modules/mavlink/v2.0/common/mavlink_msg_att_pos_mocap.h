...
{
    return mavlink_msg_att_pos_mocap_pack(system_id, component_id, msg, (uint64_t )(att_pos_mocap->time_usec), (const float *)(att_pos_mocap->q), (float )(att_pos_mocap->x), (float )(att_pos_mocap->y), (float )(att_pos_mocap->z), (const float *)(att_pos_mocap->covariance));
}
...
{
    return mavlink_msg_att_pos_mocap_pack_chan(system_id, component_id, chan, msg, (uint64_t )(att_pos_mocap->time_usec), (const float *)(att_pos_mocap->q), (float )(att_pos_mocap->x), (float )(att_pos_mocap->y), (float )(att_pos_mocap->z), (const float *)(att_pos_mocap->covariance));
}
