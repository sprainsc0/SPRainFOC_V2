...
{
    return mavlink_msg_global_vision_position_estimate_pack(system_id, component_id, msg, (uint64_t )(global_vision_position_estimate->usec), (float )(global_vision_position_estimate->x), (float )(global_vision_position_estimate->y), (float )(global_vision_position_estimate->z), (float )(global_vision_position_estimate->roll), (float )(global_vision_position_estimate->pitch), (float )(global_vision_position_estimate->yaw), (const float *)(global_vision_position_estimate->covariance), (uint8_t )(global_vision_position_estimate->reset_counter));
}
...
{
    return mavlink_msg_global_vision_position_estimate_pack_chan(system_id, component_id, chan, msg, (uint64_t )(global_vision_position_estimate->usec), (float )(global_vision_position_estimate->x), (float )(global_vision_position_estimate->y), (float )(global_vision_position_estimate->z), (float )(global_vision_position_estimate->roll), (float )(global_vision_position_estimate->pitch), (float )(global_vision_position_estimate->yaw), (const float *)(global_vision_position_estimate->covariance), (uint8_t )(global_vision_position_estimate->reset_counter));
}
