...
{
    return mavlink_msg_hil_actuator_controls_pack(system_id, component_id, msg, (uint64_t )(hil_actuator_controls->time_usec), (const float *)(hil_actuator_controls->controls), (uint8_t )(hil_actuator_controls->mode), (uint64_t )(hil_actuator_controls->flags));
}
...
{
    return mavlink_msg_hil_actuator_controls_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_actuator_controls->time_usec), (const float *)(hil_actuator_controls->controls), (uint8_t )(hil_actuator_controls->mode), (uint64_t )(hil_actuator_controls->flags));
}
