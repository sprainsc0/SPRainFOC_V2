...
{
    return mavlink_msg_cellular_config_pack(system_id, component_id, msg, (uint8_t )(cellular_config->enable_lte), (uint8_t )(cellular_config->enable_pin), (const char *)(cellular_config->pin), (const char *)(cellular_config->new_pin), (const char *)(cellular_config->apn), (const char *)(cellular_config->puk), (uint8_t )(cellular_config->roaming), (uint8_t )(cellular_config->response));
}
...
{
    return mavlink_msg_cellular_config_pack_chan(system_id, component_id, chan, msg, (uint8_t )(cellular_config->enable_lte), (uint8_t )(cellular_config->enable_pin), (const char *)(cellular_config->pin), (const char *)(cellular_config->new_pin), (const char *)(cellular_config->apn), (const char *)(cellular_config->puk), (uint8_t )(cellular_config->roaming), (uint8_t )(cellular_config->response));
}
