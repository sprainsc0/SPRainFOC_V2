...
{
    return mavlink_msg_debug_vect_pack(system_id, component_id, msg, (const char *)(debug_vect->name), (uint64_t )(debug_vect->time_usec), (float )(debug_vect->x), (float )(debug_vect->y), (float )(debug_vect->z));
}
...
{
    return mavlink_msg_debug_vect_pack_chan(system_id, component_id, chan, msg, (const char *)(debug_vect->name), (uint64_t )(debug_vect->time_usec), (float )(debug_vect->x), (float )(debug_vect->y), (float )(debug_vect->z));
}
