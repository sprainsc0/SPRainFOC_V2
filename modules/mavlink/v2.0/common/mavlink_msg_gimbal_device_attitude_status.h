...
{
    return mavlink_msg_gimbal_device_attitude_status_pack(system_id, component_id, msg, (uint8_t )(gimbal_device_attitude_status->target_system), (uint8_t )(gimbal_device_attitude_status->target_component), (uint32_t )(gimbal_device_attitude_status->time_boot_ms), (uint16_t )(gimbal_device_attitude_status->flags), (const float *)(gimbal_device_attitude_status->q), (float )(gimbal_device_attitude_status->angular_velocity_x), (float )(gimbal_device_attitude_status->angular_velocity_y), (float )(gimbal_device_attitude_status->angular_velocity_z), (uint32_t )(gimbal_device_attitude_status->failure_flags));
}
...
{
    return mavlink_msg_gimbal_device_attitude_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gimbal_device_attitude_status->target_system), (uint8_t )(gimbal_device_attitude_status->target_component), (uint32_t )(gimbal_device_attitude_status->time_boot_ms), (uint16_t )(gimbal_device_attitude_status->flags), (const float *)(gimbal_device_attitude_status->q), (float )(gimbal_device_attitude_status->angular_velocity_x), (float )(gimbal_device_attitude_status->angular_velocity_y), (float )(gimbal_device_attitude_status->angular_velocity_z), (uint32_t )(gimbal_device_attitude_status->failure_flags));
}
