...
{
    return mavlink_msg_button_change_pack(system_id, component_id, msg, (uint32_t )(button_change->time_boot_ms), (uint32_t )(button_change->last_change_ms), (uint8_t )(button_change->state));
}
...
{
    return mavlink_msg_button_change_pack_chan(system_id, component_id, chan, msg, (uint32_t )(button_change->time_boot_ms), (uint32_t )(button_change->last_change_ms), (uint8_t )(button_change->state));
}
