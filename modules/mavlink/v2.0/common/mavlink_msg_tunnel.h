...
{
    return mavlink_msg_tunnel_pack(system_id, component_id, msg, (uint8_t )(tunnel->target_system), (uint8_t )(tunnel->target_component), (uint16_t )(tunnel->payload_type), (uint8_t )(tunnel->payload_length), (const uint8_t *)(tunnel->payload));
}
...
{
    return mavlink_msg_tunnel_pack_chan(system_id, component_id, chan, msg, (uint8_t )(tunnel->target_system), (uint8_t )(tunnel->target_component), (uint16_t )(tunnel->payload_type), (uint8_t )(tunnel->payload_length), (const uint8_t *)(tunnel->payload));
}
