...
{
    return mavlink_msg_mission_request_list_pack(system_id, component_id, msg, (uint8_t )(mission_request_list->target_system), (uint8_t )(mission_request_list->target_component), (uint8_t )(mission_request_list->mission_type));
}
...
{
    return mavlink_msg_mission_request_list_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_request_list->target_system), (uint8_t )(mission_request_list->target_component), (uint8_t )(mission_request_list->mission_type));
}
