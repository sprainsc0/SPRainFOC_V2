...
{
    return mavlink_msg_logging_data_pack(system_id, component_id, msg, (uint8_t )(logging_data->target_system), (uint8_t )(logging_data->target_component), (uint16_t )(logging_data->sequence), (uint8_t )(logging_data->length), (uint8_t )(logging_data->first_message_offset), (const uint8_t *)(logging_data->data));
}
...
{
    return mavlink_msg_logging_data_pack_chan(system_id, component_id, chan, msg, (uint8_t )(logging_data->target_system), (uint8_t )(logging_data->target_component), (uint16_t )(logging_data->sequence), (uint8_t )(logging_data->length), (uint8_t )(logging_data->first_message_offset), (const uint8_t *)(logging_data->data));
}
