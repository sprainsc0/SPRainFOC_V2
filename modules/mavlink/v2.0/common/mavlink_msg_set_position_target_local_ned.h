...
{
    return mavlink_msg_set_position_target_local_ned_pack(system_id, component_id, msg, (uint32_t )(set_position_target_local_ned->time_boot_ms), (uint8_t )(set_position_target_local_ned->target_system), (uint8_t )(set_position_target_local_ned->target_component), (uint8_t )(set_position_target_local_ned->coordinate_frame), (uint16_t )(set_position_target_local_ned->type_mask), (float )(set_position_target_local_ned->x), (float )(set_position_target_local_ned->y), (float )(set_position_target_local_ned->z), (float )(set_position_target_local_ned->vx), (float )(set_position_target_local_ned->vy), (float )(set_position_target_local_ned->vz), (float )(set_position_target_local_ned->afx), (float )(set_position_target_local_ned->afy), (float )(set_position_target_local_ned->afz), (float )(set_position_target_local_ned->yaw), (float )(set_position_target_local_ned->yaw_rate));
}
...
{
    return mavlink_msg_set_position_target_local_ned_pack_chan(system_id, component_id, chan, msg, (uint32_t )(set_position_target_local_ned->time_boot_ms), (uint8_t )(set_position_target_local_ned->target_system), (uint8_t )(set_position_target_local_ned->target_component), (uint8_t )(set_position_target_local_ned->coordinate_frame), (uint16_t )(set_position_target_local_ned->type_mask), (float )(set_position_target_local_ned->x), (float )(set_position_target_local_ned->y), (float )(set_position_target_local_ned->z), (float )(set_position_target_local_ned->vx), (float )(set_position_target_local_ned->vy), (float )(set_position_target_local_ned->vz), (float )(set_position_target_local_ned->afx), (float )(set_position_target_local_ned->afy), (float )(set_position_target_local_ned->afz), (float )(set_position_target_local_ned->yaw), (float )(set_position_target_local_ned->yaw_rate));
}
