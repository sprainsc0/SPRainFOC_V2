...
{
    return mavlink_msg_wheel_distance_pack(system_id, component_id, msg, (uint64_t )(wheel_distance->time_usec), (uint8_t )(wheel_distance->count), (const double *)(wheel_distance->distance));
}
...
{
    return mavlink_msg_wheel_distance_pack_chan(system_id, component_id, chan, msg, (uint64_t )(wheel_distance->time_usec), (uint8_t )(wheel_distance->count), (const double *)(wheel_distance->distance));
}
