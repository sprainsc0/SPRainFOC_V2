...
{
    return mavlink_msg_gimbal_manager_set_manual_control_pack(system_id, component_id, msg, (uint8_t )(gimbal_manager_set_manual_control->target_system), (uint8_t )(gimbal_manager_set_manual_control->target_component), (uint32_t )(gimbal_manager_set_manual_control->flags), (uint8_t )(gimbal_manager_set_manual_control->gimbal_device_id), (float )(gimbal_manager_set_manual_control->pitch), (float )(gimbal_manager_set_manual_control->yaw), (float )(gimbal_manager_set_manual_control->pitch_rate), (float )(gimbal_manager_set_manual_control->yaw_rate));
}
...
{
    return mavlink_msg_gimbal_manager_set_manual_control_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gimbal_manager_set_manual_control->target_system), (uint8_t )(gimbal_manager_set_manual_control->target_component), (uint32_t )(gimbal_manager_set_manual_control->flags), (uint8_t )(gimbal_manager_set_manual_control->gimbal_device_id), (float )(gimbal_manager_set_manual_control->pitch), (float )(gimbal_manager_set_manual_control->yaw), (float )(gimbal_manager_set_manual_control->pitch_rate), (float )(gimbal_manager_set_manual_control->yaw_rate));
}
