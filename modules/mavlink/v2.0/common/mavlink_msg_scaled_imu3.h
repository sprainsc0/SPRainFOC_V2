...
{
    return mavlink_msg_scaled_imu3_pack(system_id, component_id, msg, (uint32_t )(scaled_imu3->time_boot_ms), (int16_t )(scaled_imu3->xacc), (int16_t )(scaled_imu3->yacc), (int16_t )(scaled_imu3->zacc), (int16_t )(scaled_imu3->xgyro), (int16_t )(scaled_imu3->ygyro), (int16_t )(scaled_imu3->zgyro), (int16_t )(scaled_imu3->xmag), (int16_t )(scaled_imu3->ymag), (int16_t )(scaled_imu3->zmag), (int16_t )(scaled_imu3->temperature));
}
...
{
    return mavlink_msg_scaled_imu3_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_imu3->time_boot_ms), (int16_t )(scaled_imu3->xacc), (int16_t )(scaled_imu3->yacc), (int16_t )(scaled_imu3->zacc), (int16_t )(scaled_imu3->xgyro), (int16_t )(scaled_imu3->ygyro), (int16_t )(scaled_imu3->zgyro), (int16_t )(scaled_imu3->xmag), (int16_t )(scaled_imu3->ymag), (int16_t )(scaled_imu3->zmag), (int16_t )(scaled_imu3->temperature));
}
