...
{
    return mavlink_msg_extended_sys_state_pack(system_id, component_id, msg, (uint8_t )(extended_sys_state->vtol_state), (uint8_t )(extended_sys_state->landed_state));
}
...
{
    return mavlink_msg_extended_sys_state_pack_chan(system_id, component_id, chan, msg, (uint8_t )(extended_sys_state->vtol_state), (uint8_t )(extended_sys_state->landed_state));
}
