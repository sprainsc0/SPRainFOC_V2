...
{
    return mavlink_msg_autopilot_version_pack(system_id, component_id, msg, (uint64_t )(autopilot_version->capabilities), (uint32_t )(autopilot_version->flight_sw_version), (uint32_t )(autopilot_version->middleware_sw_version), (uint32_t )(autopilot_version->os_sw_version), (uint32_t )(autopilot_version->board_version), (const uint8_t *)(autopilot_version->flight_custom_version), (const uint8_t *)(autopilot_version->middleware_custom_version), (const uint8_t *)(autopilot_version->os_custom_version), (uint16_t )(autopilot_version->vendor_id), (uint16_t )(autopilot_version->product_id), (uint64_t )(autopilot_version->uid), (const uint8_t *)(autopilot_version->uid2));
}
...
{
    return mavlink_msg_autopilot_version_pack_chan(system_id, component_id, chan, msg, (uint64_t )(autopilot_version->capabilities), (uint32_t )(autopilot_version->flight_sw_version), (uint32_t )(autopilot_version->middleware_sw_version), (uint32_t )(autopilot_version->os_sw_version), (uint32_t )(autopilot_version->board_version), (const uint8_t *)(autopilot_version->flight_custom_version), (const uint8_t *)(autopilot_version->middleware_custom_version), (const uint8_t *)(autopilot_version->os_custom_version), (uint16_t )(autopilot_version->vendor_id), (uint16_t )(autopilot_version->product_id), (uint64_t )(autopilot_version->uid), (const uint8_t *)(autopilot_version->uid2));
}
