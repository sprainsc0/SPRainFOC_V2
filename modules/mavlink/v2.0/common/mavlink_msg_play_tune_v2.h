...
{
    return mavlink_msg_play_tune_v2_pack(system_id, component_id, msg, (uint8_t )(play_tune_v2->target_system), (uint8_t )(play_tune_v2->target_component), (uint32_t )(play_tune_v2->format), (const char *)(play_tune_v2->tune));
}
...
{
    return mavlink_msg_play_tune_v2_pack_chan(system_id, component_id, chan, msg, (uint8_t )(play_tune_v2->target_system), (uint8_t )(play_tune_v2->target_component), (uint32_t )(play_tune_v2->format), (const char *)(play_tune_v2->tune));
}
