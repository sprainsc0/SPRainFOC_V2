...
{
    return mavlink_msg_camera_fov_status_pack(system_id, component_id, msg, (uint32_t )(camera_fov_status->time_boot_ms), (int32_t )(camera_fov_status->lat_camera), (int32_t )(camera_fov_status->lon_camera), (int32_t )(camera_fov_status->alt_camera), (int32_t )(camera_fov_status->lat_image), (int32_t )(camera_fov_status->lon_image), (int32_t )(camera_fov_status->alt_image), (const float *)(camera_fov_status->q), (float )(camera_fov_status->hfov), (float )(camera_fov_status->vfov));
}
...
{
    return mavlink_msg_camera_fov_status_pack_chan(system_id, component_id, chan, msg, (uint32_t )(camera_fov_status->time_boot_ms), (int32_t )(camera_fov_status->lat_camera), (int32_t )(camera_fov_status->lon_camera), (int32_t )(camera_fov_status->alt_camera), (int32_t )(camera_fov_status->lat_image), (int32_t )(camera_fov_status->lon_image), (int32_t )(camera_fov_status->alt_image), (const float *)(camera_fov_status->q), (float )(camera_fov_status->hfov), (float )(camera_fov_status->vfov));
}
