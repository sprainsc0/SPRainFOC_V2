...
{
    return mavlink_msg_command_long_pack(system_id, component_id, msg, (uint8_t )(command_long->target_system), (uint8_t )(command_long->target_component), (uint16_t )(command_long->command), (uint8_t )(command_long->confirmation), (float )(command_long->param1), (float )(command_long->param2), (float )(command_long->param3), (float )(command_long->param4), (float )(command_long->param5), (float )(command_long->param6), (float )(command_long->param7));
}
...
{
    return mavlink_msg_command_long_pack_chan(system_id, component_id, chan, msg, (uint8_t )(command_long->target_system), (uint8_t )(command_long->target_component), (uint16_t )(command_long->command), (uint8_t )(command_long->confirmation), (float )(command_long->param1), (float )(command_long->param2), (float )(command_long->param3), (float )(command_long->param4), (float )(command_long->param5), (float )(command_long->param6), (float )(command_long->param7));
}
