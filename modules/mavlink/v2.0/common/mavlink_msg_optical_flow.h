...
{
    return mavlink_msg_optical_flow_pack(system_id, component_id, msg, (uint64_t )(optical_flow->time_usec), (uint8_t )(optical_flow->sensor_id), (int16_t )(optical_flow->flow_x), (int16_t )(optical_flow->flow_y), (float )(optical_flow->flow_comp_m_x), (float )(optical_flow->flow_comp_m_y), (uint8_t )(optical_flow->quality), (float )(optical_flow->ground_distance), (float )(optical_flow->flow_rate_x), (float )(optical_flow->flow_rate_y));
}
...
{
    return mavlink_msg_optical_flow_pack_chan(system_id, component_id, chan, msg, (uint64_t )(optical_flow->time_usec), (uint8_t )(optical_flow->sensor_id), (int16_t )(optical_flow->flow_x), (int16_t )(optical_flow->flow_y), (float )(optical_flow->flow_comp_m_x), (float )(optical_flow->flow_comp_m_y), (uint8_t )(optical_flow->quality), (float )(optical_flow->ground_distance), (float )(optical_flow->flow_rate_x), (float )(optical_flow->flow_rate_y));
}
