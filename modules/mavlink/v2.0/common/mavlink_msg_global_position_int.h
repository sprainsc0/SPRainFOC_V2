...
{
    return mavlink_msg_global_position_int_pack(system_id, component_id, msg, (uint32_t )(global_position_int->time_boot_ms), (int32_t )(global_position_int->lat), (int32_t )(global_position_int->lon), (int32_t )(global_position_int->alt), (int32_t )(global_position_int->relative_alt), (int16_t )(global_position_int->vx), (int16_t )(global_position_int->vy), (int16_t )(global_position_int->vz), (uint16_t )(global_position_int->hdg));
}
...
{
    return mavlink_msg_global_position_int_pack_chan(system_id, component_id, chan, msg, (uint32_t )(global_position_int->time_boot_ms), (int32_t )(global_position_int->lat), (int32_t )(global_position_int->lon), (int32_t )(global_position_int->alt), (int32_t )(global_position_int->relative_alt), (int16_t )(global_position_int->vx), (int16_t )(global_position_int->vy), (int16_t )(global_position_int->vz), (uint16_t )(global_position_int->hdg));
}
