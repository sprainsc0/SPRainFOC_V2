...
{
    return mavlink_msg_supported_tunes_pack(system_id, component_id, msg, (uint8_t )(supported_tunes->target_system), (uint8_t )(supported_tunes->target_component), (uint32_t )(supported_tunes->format));
}
...
{
    return mavlink_msg_supported_tunes_pack_chan(system_id, component_id, chan, msg, (uint8_t )(supported_tunes->target_system), (uint8_t )(supported_tunes->target_component), (uint32_t )(supported_tunes->format));
}
