...
{
    return mavlink_msg_flight_information_pack(system_id, component_id, msg, (uint32_t )(flight_information->time_boot_ms), (uint64_t )(flight_information->arming_time_utc), (uint64_t )(flight_information->takeoff_time_utc), (uint64_t )(flight_information->flight_uuid));
}
...
{
    return mavlink_msg_flight_information_pack_chan(system_id, component_id, chan, msg, (uint32_t )(flight_information->time_boot_ms), (uint64_t )(flight_information->arming_time_utc), (uint64_t )(flight_information->takeoff_time_utc), (uint64_t )(flight_information->flight_uuid));
}
