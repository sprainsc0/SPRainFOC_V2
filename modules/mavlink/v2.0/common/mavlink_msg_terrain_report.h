...
{
    return mavlink_msg_terrain_report_pack(system_id, component_id, msg, (int32_t )(terrain_report->lat), (int32_t )(terrain_report->lon), (uint16_t )(terrain_report->spacing), (float )(terrain_report->terrain_height), (float )(terrain_report->current_height), (uint16_t )(terrain_report->pending), (uint16_t )(terrain_report->loaded));
}
...
{
    return mavlink_msg_terrain_report_pack_chan(system_id, component_id, chan, msg, (int32_t )(terrain_report->lat), (int32_t )(terrain_report->lon), (uint16_t )(terrain_report->spacing), (float )(terrain_report->terrain_height), (float )(terrain_report->current_height), (uint16_t )(terrain_report->pending), (uint16_t )(terrain_report->loaded));
}
