...
{
    return mavlink_msg_raw_imu_pack(system_id, component_id, msg, (uint64_t )(raw_imu->time_usec), (int16_t )(raw_imu->xacc), (int16_t )(raw_imu->yacc), (int16_t )(raw_imu->zacc), (int16_t )(raw_imu->xgyro), (int16_t )(raw_imu->ygyro), (int16_t )(raw_imu->zgyro), (int16_t )(raw_imu->xmag), (int16_t )(raw_imu->ymag), (int16_t )(raw_imu->zmag), (uint8_t )(raw_imu->id), (int16_t )(raw_imu->temperature));
}
...
{
    return mavlink_msg_raw_imu_pack_chan(system_id, component_id, chan, msg, (uint64_t )(raw_imu->time_usec), (int16_t )(raw_imu->xacc), (int16_t )(raw_imu->yacc), (int16_t )(raw_imu->zacc), (int16_t )(raw_imu->xgyro), (int16_t )(raw_imu->ygyro), (int16_t )(raw_imu->zgyro), (int16_t )(raw_imu->xmag), (int16_t )(raw_imu->ymag), (int16_t )(raw_imu->zmag), (uint8_t )(raw_imu->id), (int16_t )(raw_imu->temperature));
}
