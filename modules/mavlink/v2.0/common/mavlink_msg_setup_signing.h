...
{
    return mavlink_msg_setup_signing_pack(system_id, component_id, msg, (uint8_t )(setup_signing->target_system), (uint8_t )(setup_signing->target_component), (const uint8_t *)(setup_signing->secret_key), (uint64_t )(setup_signing->initial_timestamp));
}
...
{
    return mavlink_msg_setup_signing_pack_chan(system_id, component_id, chan, msg, (uint8_t )(setup_signing->target_system), (uint8_t )(setup_signing->target_component), (const uint8_t *)(setup_signing->secret_key), (uint64_t )(setup_signing->initial_timestamp));
}
