...
{
    return mavlink_msg_camera_settings_pack(system_id, component_id, msg, (uint32_t )(camera_settings->time_boot_ms), (uint8_t )(camera_settings->mode_id), (float )(camera_settings->zoomLevel), (float )(camera_settings->focusLevel));
}
...
{
    return mavlink_msg_camera_settings_pack_chan(system_id, component_id, chan, msg, (uint32_t )(camera_settings->time_boot_ms), (uint8_t )(camera_settings->mode_id), (float )(camera_settings->zoomLevel), (float )(camera_settings->focusLevel));
}
