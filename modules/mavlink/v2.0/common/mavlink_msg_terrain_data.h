...
{
    return mavlink_msg_terrain_data_pack(system_id, component_id, msg, (int32_t )(terrain_data->lat), (int32_t )(terrain_data->lon), (uint16_t )(terrain_data->grid_spacing), (uint8_t )(terrain_data->gridbit), (const int16_t *)(terrain_data->data));
}
...
{
    return mavlink_msg_terrain_data_pack_chan(system_id, component_id, chan, msg, (int32_t )(terrain_data->lat), (int32_t )(terrain_data->lon), (uint16_t )(terrain_data->grid_spacing), (uint8_t )(terrain_data->gridbit), (const int16_t *)(terrain_data->data));
}
