...
{
    return mavlink_msg_scaled_imu_pack(system_id, component_id, msg, (uint32_t )(scaled_imu->time_boot_ms), (int16_t )(scaled_imu->xacc), (int16_t )(scaled_imu->yacc), (int16_t )(scaled_imu->zacc), (int16_t )(scaled_imu->xgyro), (int16_t )(scaled_imu->ygyro), (int16_t )(scaled_imu->zgyro), (int16_t )(scaled_imu->xmag), (int16_t )(scaled_imu->ymag), (int16_t )(scaled_imu->zmag), (int16_t )(scaled_imu->temperature));
}
...
{
    return mavlink_msg_scaled_imu_pack_chan(system_id, component_id, chan, msg, (uint32_t )(scaled_imu->time_boot_ms), (int16_t )(scaled_imu->xacc), (int16_t )(scaled_imu->yacc), (int16_t )(scaled_imu->zacc), (int16_t )(scaled_imu->xgyro), (int16_t )(scaled_imu->ygyro), (int16_t )(scaled_imu->zgyro), (int16_t )(scaled_imu->xmag), (int16_t )(scaled_imu->ymag), (int16_t )(scaled_imu->zmag), (int16_t )(scaled_imu->temperature));
}
