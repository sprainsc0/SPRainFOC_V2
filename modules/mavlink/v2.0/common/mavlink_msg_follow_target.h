...
{
    return mavlink_msg_follow_target_pack(system_id, component_id, msg, (uint64_t )(follow_target->timestamp), (uint8_t )(follow_target->est_capabilities), (int32_t )(follow_target->lat), (int32_t )(follow_target->lon), (float )(follow_target->alt), (const float *)(follow_target->vel), (const float *)(follow_target->acc), (const float *)(follow_target->attitude_q), (const float *)(follow_target->rates), (const float *)(follow_target->position_cov), (uint64_t )(follow_target->custom_state));
}
...
{
    return mavlink_msg_follow_target_pack_chan(system_id, component_id, chan, msg, (uint64_t )(follow_target->timestamp), (uint8_t )(follow_target->est_capabilities), (int32_t )(follow_target->lat), (int32_t )(follow_target->lon), (float )(follow_target->alt), (const float *)(follow_target->vel), (const float *)(follow_target->acc), (const float *)(follow_target->attitude_q), (const float *)(follow_target->rates), (const float *)(follow_target->position_cov), (uint64_t )(follow_target->custom_state));
}
