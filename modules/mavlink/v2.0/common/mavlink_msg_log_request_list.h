...
{
    return mavlink_msg_log_request_list_pack(system_id, component_id, msg, (uint8_t )(log_request_list->target_system), (uint8_t )(log_request_list->target_component), (uint16_t )(log_request_list->start), (uint16_t )(log_request_list->end));
}
...
{
    return mavlink_msg_log_request_list_pack_chan(system_id, component_id, chan, msg, (uint8_t )(log_request_list->target_system), (uint8_t )(log_request_list->target_component), (uint16_t )(log_request_list->start), (uint16_t )(log_request_list->end));
}
