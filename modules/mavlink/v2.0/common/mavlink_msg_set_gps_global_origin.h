...
{
    return mavlink_msg_set_gps_global_origin_pack(system_id, component_id, msg, (uint8_t )(set_gps_global_origin->target_system), (int32_t )(set_gps_global_origin->latitude), (int32_t )(set_gps_global_origin->longitude), (int32_t )(set_gps_global_origin->altitude), (uint64_t )(set_gps_global_origin->time_usec));
}
...
{
    return mavlink_msg_set_gps_global_origin_pack_chan(system_id, component_id, chan, msg, (uint8_t )(set_gps_global_origin->target_system), (int32_t )(set_gps_global_origin->latitude), (int32_t )(set_gps_global_origin->longitude), (int32_t )(set_gps_global_origin->altitude), (uint64_t )(set_gps_global_origin->time_usec));
}
