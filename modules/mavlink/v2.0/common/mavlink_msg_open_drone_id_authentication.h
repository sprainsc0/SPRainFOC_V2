...
{
    return mavlink_msg_open_drone_id_authentication_pack(system_id, component_id, msg, (uint8_t )(open_drone_id_authentication->target_system), (uint8_t )(open_drone_id_authentication->target_component), (const uint8_t *)(open_drone_id_authentication->id_or_mac), (uint8_t )(open_drone_id_authentication->authentication_type), (uint8_t )(open_drone_id_authentication->data_page), (uint8_t )(open_drone_id_authentication->page_count), (uint8_t )(open_drone_id_authentication->length), (uint32_t )(open_drone_id_authentication->timestamp), (const uint8_t *)(open_drone_id_authentication->authentication_data));
}
...
{
    return mavlink_msg_open_drone_id_authentication_pack_chan(system_id, component_id, chan, msg, (uint8_t )(open_drone_id_authentication->target_system), (uint8_t )(open_drone_id_authentication->target_component), (const uint8_t *)(open_drone_id_authentication->id_or_mac), (uint8_t )(open_drone_id_authentication->authentication_type), (uint8_t )(open_drone_id_authentication->data_page), (uint8_t )(open_drone_id_authentication->page_count), (uint8_t )(open_drone_id_authentication->length), (uint32_t )(open_drone_id_authentication->timestamp), (const uint8_t *)(open_drone_id_authentication->authentication_data));
}
