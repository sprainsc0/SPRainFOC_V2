...
{
    return mavlink_msg_resource_request_pack(system_id, component_id, msg, (uint8_t )(resource_request->request_id), (uint8_t )(resource_request->uri_type), (const uint8_t *)(resource_request->uri), (uint8_t )(resource_request->transfer_type), (const uint8_t *)(resource_request->storage));
}
...
{
    return mavlink_msg_resource_request_pack_chan(system_id, component_id, chan, msg, (uint8_t )(resource_request->request_id), (uint8_t )(resource_request->uri_type), (const uint8_t *)(resource_request->uri), (uint8_t )(resource_request->transfer_type), (const uint8_t *)(resource_request->storage));
}
