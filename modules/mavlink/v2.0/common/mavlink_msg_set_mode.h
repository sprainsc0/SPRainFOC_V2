...
{
    return mavlink_msg_set_mode_pack(system_id, component_id, msg, (uint8_t )(set_mode->target_system), (uint8_t )(set_mode->base_mode), (uint32_t )(set_mode->custom_mode));
}
...
{
    return mavlink_msg_set_mode_pack_chan(system_id, component_id, chan, msg, (uint8_t )(set_mode->target_system), (uint8_t )(set_mode->base_mode), (uint32_t )(set_mode->custom_mode));
}
