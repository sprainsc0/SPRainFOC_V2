...
{
    return mavlink_msg_hil_rc_inputs_raw_pack(system_id, component_id, msg, (uint64_t )(hil_rc_inputs_raw->time_usec), (uint16_t )(hil_rc_inputs_raw->chan1_raw), (uint16_t )(hil_rc_inputs_raw->chan2_raw), (uint16_t )(hil_rc_inputs_raw->chan3_raw), (uint16_t )(hil_rc_inputs_raw->chan4_raw), (uint16_t )(hil_rc_inputs_raw->chan5_raw), (uint16_t )(hil_rc_inputs_raw->chan6_raw), (uint16_t )(hil_rc_inputs_raw->chan7_raw), (uint16_t )(hil_rc_inputs_raw->chan8_raw), (uint16_t )(hil_rc_inputs_raw->chan9_raw), (uint16_t )(hil_rc_inputs_raw->chan10_raw), (uint16_t )(hil_rc_inputs_raw->chan11_raw), (uint16_t )(hil_rc_inputs_raw->chan12_raw), (uint8_t )(hil_rc_inputs_raw->rssi));
}
...
{
    return mavlink_msg_hil_rc_inputs_raw_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_rc_inputs_raw->time_usec), (uint16_t )(hil_rc_inputs_raw->chan1_raw), (uint16_t )(hil_rc_inputs_raw->chan2_raw), (uint16_t )(hil_rc_inputs_raw->chan3_raw), (uint16_t )(hil_rc_inputs_raw->chan4_raw), (uint16_t )(hil_rc_inputs_raw->chan5_raw), (uint16_t )(hil_rc_inputs_raw->chan6_raw), (uint16_t )(hil_rc_inputs_raw->chan7_raw), (uint16_t )(hil_rc_inputs_raw->chan8_raw), (uint16_t )(hil_rc_inputs_raw->chan9_raw), (uint16_t )(hil_rc_inputs_raw->chan10_raw), (uint16_t )(hil_rc_inputs_raw->chan11_raw), (uint16_t )(hil_rc_inputs_raw->chan12_raw), (uint8_t )(hil_rc_inputs_raw->rssi));
}
