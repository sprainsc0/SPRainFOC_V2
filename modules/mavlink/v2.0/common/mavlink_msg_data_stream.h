...
{
    return mavlink_msg_data_stream_pack(system_id, component_id, msg, (uint8_t )(data_stream->stream_id), (uint16_t )(data_stream->message_rate), (uint8_t )(data_stream->on_off));
}
...
{
    return mavlink_msg_data_stream_pack_chan(system_id, component_id, chan, msg, (uint8_t )(data_stream->stream_id), (uint16_t )(data_stream->message_rate), (uint8_t )(data_stream->on_off));
}
