...
{
    return mavlink_msg_open_drone_id_system_pack(system_id, component_id, msg, (uint8_t )(open_drone_id_system->target_system), (uint8_t )(open_drone_id_system->target_component), (const uint8_t *)(open_drone_id_system->id_or_mac), (uint8_t )(open_drone_id_system->operator_location_type), (uint8_t )(open_drone_id_system->classification_type), (int32_t )(open_drone_id_system->operator_latitude), (int32_t )(open_drone_id_system->operator_longitude), (uint16_t )(open_drone_id_system->area_count), (uint16_t )(open_drone_id_system->area_radius), (float )(open_drone_id_system->area_ceiling), (float )(open_drone_id_system->area_floor), (uint8_t )(open_drone_id_system->category_eu), (uint8_t )(open_drone_id_system->class_eu));
}
...
{
    return mavlink_msg_open_drone_id_system_pack_chan(system_id, component_id, chan, msg, (uint8_t )(open_drone_id_system->target_system), (uint8_t )(open_drone_id_system->target_component), (const uint8_t *)(open_drone_id_system->id_or_mac), (uint8_t )(open_drone_id_system->operator_location_type), (uint8_t )(open_drone_id_system->classification_type), (int32_t )(open_drone_id_system->operator_latitude), (int32_t )(open_drone_id_system->operator_longitude), (uint16_t )(open_drone_id_system->area_count), (uint16_t )(open_drone_id_system->area_radius), (float )(open_drone_id_system->area_ceiling), (float )(open_drone_id_system->area_floor), (uint8_t )(open_drone_id_system->category_eu), (uint8_t )(open_drone_id_system->class_eu));
}
