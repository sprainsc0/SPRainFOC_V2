...
{
    return mavlink_msg_adsb_vehicle_pack(system_id, component_id, msg, (uint32_t )(adsb_vehicle->ICAO_address), (int32_t )(adsb_vehicle->lat), (int32_t )(adsb_vehicle->lon), (uint8_t )(adsb_vehicle->altitude_type), (int32_t )(adsb_vehicle->altitude), (uint16_t )(adsb_vehicle->heading), (uint16_t )(adsb_vehicle->hor_velocity), (int16_t )(adsb_vehicle->ver_velocity), (const char *)(adsb_vehicle->callsign), (uint8_t )(adsb_vehicle->emitter_type), (uint8_t )(adsb_vehicle->tslc), (uint16_t )(adsb_vehicle->flags), (uint16_t )(adsb_vehicle->squawk));
}
...
{
    return mavlink_msg_adsb_vehicle_pack_chan(system_id, component_id, chan, msg, (uint32_t )(adsb_vehicle->ICAO_address), (int32_t )(adsb_vehicle->lat), (int32_t )(adsb_vehicle->lon), (uint8_t )(adsb_vehicle->altitude_type), (int32_t )(adsb_vehicle->altitude), (uint16_t )(adsb_vehicle->heading), (uint16_t )(adsb_vehicle->hor_velocity), (int16_t )(adsb_vehicle->ver_velocity), (const char *)(adsb_vehicle->callsign), (uint8_t )(adsb_vehicle->emitter_type), (uint8_t )(adsb_vehicle->tslc), (uint16_t )(adsb_vehicle->flags), (uint16_t )(adsb_vehicle->squawk));
}
