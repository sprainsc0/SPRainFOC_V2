...
{
    return mavlink_msg_autopilot_state_for_gimbal_device_pack(system_id, component_id, msg, (uint8_t )(autopilot_state_for_gimbal_device->target_system), (uint8_t )(autopilot_state_for_gimbal_device->target_component), (uint64_t )(autopilot_state_for_gimbal_device->time_boot_us), (const float *)(autopilot_state_for_gimbal_device->q), (uint32_t )(autopilot_state_for_gimbal_device->q_estimated_delay_us), (float )(autopilot_state_for_gimbal_device->vx), (float )(autopilot_state_for_gimbal_device->vy), (float )(autopilot_state_for_gimbal_device->vz), (uint32_t )(autopilot_state_for_gimbal_device->v_estimated_delay_us), (float )(autopilot_state_for_gimbal_device->feed_forward_angular_velocity_z), (uint16_t )(autopilot_state_for_gimbal_device->estimator_status), (uint8_t )(autopilot_state_for_gimbal_device->landed_state));
}
...
{
    return mavlink_msg_autopilot_state_for_gimbal_device_pack_chan(system_id, component_id, chan, msg, (uint8_t )(autopilot_state_for_gimbal_device->target_system), (uint8_t )(autopilot_state_for_gimbal_device->target_component), (uint64_t )(autopilot_state_for_gimbal_device->time_boot_us), (const float *)(autopilot_state_for_gimbal_device->q), (uint32_t )(autopilot_state_for_gimbal_device->q_estimated_delay_us), (float )(autopilot_state_for_gimbal_device->vx), (float )(autopilot_state_for_gimbal_device->vy), (float )(autopilot_state_for_gimbal_device->vz), (uint32_t )(autopilot_state_for_gimbal_device->v_estimated_delay_us), (float )(autopilot_state_for_gimbal_device->feed_forward_angular_velocity_z), (uint16_t )(autopilot_state_for_gimbal_device->estimator_status), (uint8_t )(autopilot_state_for_gimbal_device->landed_state));
}
