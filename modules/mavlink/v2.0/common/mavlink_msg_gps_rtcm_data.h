...
{
    return mavlink_msg_gps_rtcm_data_pack(system_id, component_id, msg, (uint8_t )(gps_rtcm_data->flags), (uint8_t )(gps_rtcm_data->len), (const uint8_t *)(gps_rtcm_data->data));
}
...
{
    return mavlink_msg_gps_rtcm_data_pack_chan(system_id, component_id, chan, msg, (uint8_t )(gps_rtcm_data->flags), (uint8_t )(gps_rtcm_data->len), (const uint8_t *)(gps_rtcm_data->data));
}
