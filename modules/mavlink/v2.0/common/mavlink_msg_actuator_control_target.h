...
{
    return mavlink_msg_actuator_control_target_pack(system_id, component_id, msg, (uint64_t )(actuator_control_target->time_usec), (uint8_t )(actuator_control_target->group_mlx), (const float *)(actuator_control_target->controls));
}
...
{
    return mavlink_msg_actuator_control_target_pack_chan(system_id, component_id, chan, msg, (uint64_t )(actuator_control_target->time_usec), (uint8_t )(actuator_control_target->group_mlx), (const float *)(actuator_control_target->controls));
}
