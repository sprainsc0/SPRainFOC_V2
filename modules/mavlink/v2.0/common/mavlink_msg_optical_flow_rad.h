...
{
    return mavlink_msg_optical_flow_rad_pack(system_id, component_id, msg, (uint64_t )(optical_flow_rad->time_usec), (uint8_t )(optical_flow_rad->sensor_id), (uint32_t )(optical_flow_rad->integration_time_us), (float )(optical_flow_rad->integrated_x), (float )(optical_flow_rad->integrated_y), (float )(optical_flow_rad->integrated_xgyro), (float )(optical_flow_rad->integrated_ygyro), (float )(optical_flow_rad->integrated_zgyro), (int16_t )(optical_flow_rad->temperature), (uint8_t )(optical_flow_rad->quality), (uint32_t )(optical_flow_rad->time_delta_distance_us), (float )(optical_flow_rad->distance));
}
...
{
    return mavlink_msg_optical_flow_rad_pack_chan(system_id, component_id, chan, msg, (uint64_t )(optical_flow_rad->time_usec), (uint8_t )(optical_flow_rad->sensor_id), (uint32_t )(optical_flow_rad->integration_time_us), (float )(optical_flow_rad->integrated_x), (float )(optical_flow_rad->integrated_y), (float )(optical_flow_rad->integrated_xgyro), (float )(optical_flow_rad->integrated_ygyro), (float )(optical_flow_rad->integrated_zgyro), (int16_t )(optical_flow_rad->temperature), (uint8_t )(optical_flow_rad->quality), (uint32_t )(optical_flow_rad->time_delta_distance_us), (float )(optical_flow_rad->distance));
}
