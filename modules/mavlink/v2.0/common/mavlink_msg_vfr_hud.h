...
{
    return mavlink_msg_vfr_hud_pack(system_id, component_id, msg, (float )(vfr_hud->airspeed), (float )(vfr_hud->groundspeed), (int16_t )(vfr_hud->heading), (uint16_t )(vfr_hud->throttle), (float )(vfr_hud->alt), (float )(vfr_hud->climb));
}
...
{
    return mavlink_msg_vfr_hud_pack_chan(system_id, component_id, chan, msg, (float )(vfr_hud->airspeed), (float )(vfr_hud->groundspeed), (int16_t )(vfr_hud->heading), (uint16_t )(vfr_hud->throttle), (float )(vfr_hud->alt), (float )(vfr_hud->climb));
}
