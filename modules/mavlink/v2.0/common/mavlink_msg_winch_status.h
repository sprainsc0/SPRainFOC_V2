...
{
    return mavlink_msg_winch_status_pack(system_id, component_id, msg, (uint64_t )(winch_status->time_usec), (float )(winch_status->line_length), (float )(winch_status->speed), (float )(winch_status->tension), (float )(winch_status->voltage), (float )(winch_status->current), (int16_t )(winch_status->temperature), (uint32_t )(winch_status->status));
}
...
{
    return mavlink_msg_winch_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(winch_status->time_usec), (float )(winch_status->line_length), (float )(winch_status->speed), (float )(winch_status->tension), (float )(winch_status->voltage), (float )(winch_status->current), (int16_t )(winch_status->temperature), (uint32_t )(winch_status->status));
}
