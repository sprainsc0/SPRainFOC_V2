...
{
    return mavlink_msg_hil_state_quaternion_pack(system_id, component_id, msg, (uint64_t )(hil_state_quaternion->time_usec), (const float *)(hil_state_quaternion->attitude_quaternion), (float )(hil_state_quaternion->rollspeed), (float )(hil_state_quaternion->pitchspeed), (float )(hil_state_quaternion->yawspeed), (int32_t )(hil_state_quaternion->lat), (int32_t )(hil_state_quaternion->lon), (int32_t )(hil_state_quaternion->alt), (int16_t )(hil_state_quaternion->vx), (int16_t )(hil_state_quaternion->vy), (int16_t )(hil_state_quaternion->vz), (uint16_t )(hil_state_quaternion->ind_airspeed), (uint16_t )(hil_state_quaternion->true_airspeed), (int16_t )(hil_state_quaternion->xacc), (int16_t )(hil_state_quaternion->yacc), (int16_t )(hil_state_quaternion->zacc));
}
...
{
    return mavlink_msg_hil_state_quaternion_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_state_quaternion->time_usec), (const float *)(hil_state_quaternion->attitude_quaternion), (float )(hil_state_quaternion->rollspeed), (float )(hil_state_quaternion->pitchspeed), (float )(hil_state_quaternion->yawspeed), (int32_t )(hil_state_quaternion->lat), (int32_t )(hil_state_quaternion->lon), (int32_t )(hil_state_quaternion->alt), (int16_t )(hil_state_quaternion->vx), (int16_t )(hil_state_quaternion->vy), (int16_t )(hil_state_quaternion->vz), (uint16_t )(hil_state_quaternion->ind_airspeed), (uint16_t )(hil_state_quaternion->true_airspeed), (int16_t )(hil_state_quaternion->xacc), (int16_t )(hil_state_quaternion->yacc), (int16_t )(hil_state_quaternion->zacc));
}
