...
{
    return mavlink_msg_open_drone_id_message_pack_pack(system_id, component_id, msg, (uint8_t )(open_drone_id_message_pack->target_system), (uint8_t )(open_drone_id_message_pack->target_component), (uint8_t )(open_drone_id_message_pack->single_message_size), (uint8_t )(open_drone_id_message_pack->msg_pack_size), (const uint8_t *)(open_drone_id_message_pack->messages));
}
...
{
    return mavlink_msg_open_drone_id_message_pack_pack_chan(system_id, component_id, chan, msg, (uint8_t )(open_drone_id_message_pack->target_system), (uint8_t )(open_drone_id_message_pack->target_component), (uint8_t )(open_drone_id_message_pack->single_message_size), (uint8_t )(open_drone_id_message_pack->msg_pack_size), (const uint8_t *)(open_drone_id_message_pack->messages));
}
