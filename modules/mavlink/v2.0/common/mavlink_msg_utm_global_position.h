...
{
    return mavlink_msg_utm_global_position_pack(system_id, component_id, msg, (uint64_t )(utm_global_position->time), (const uint8_t *)(utm_global_position->uas_id), (int32_t )(utm_global_position->lat), (int32_t )(utm_global_position->lon), (int32_t )(utm_global_position->alt), (int32_t )(utm_global_position->relative_alt), (int16_t )(utm_global_position->vx), (int16_t )(utm_global_position->vy), (int16_t )(utm_global_position->vz), (uint16_t )(utm_global_position->h_acc), (uint16_t )(utm_global_position->v_acc), (uint16_t )(utm_global_position->vel_acc), (int32_t )(utm_global_position->next_lat), (int32_t )(utm_global_position->next_lon), (int32_t )(utm_global_position->next_alt), (uint16_t )(utm_global_position->update_rate), (uint8_t )(utm_global_position->flight_state), (uint8_t )(utm_global_position->flags));
}
...
{
    return mavlink_msg_utm_global_position_pack_chan(system_id, component_id, chan, msg, (uint64_t )(utm_global_position->time), (const uint8_t *)(utm_global_position->uas_id), (int32_t )(utm_global_position->lat), (int32_t )(utm_global_position->lon), (int32_t )(utm_global_position->alt), (int32_t )(utm_global_position->relative_alt), (int16_t )(utm_global_position->vx), (int16_t )(utm_global_position->vy), (int16_t )(utm_global_position->vz), (uint16_t )(utm_global_position->h_acc), (uint16_t )(utm_global_position->v_acc), (uint16_t )(utm_global_position->vel_acc), (int32_t )(utm_global_position->next_lat), (int32_t )(utm_global_position->next_lon), (int32_t )(utm_global_position->next_alt), (uint16_t )(utm_global_position->update_rate), (uint8_t )(utm_global_position->flight_state), (uint8_t )(utm_global_position->flags));
}
