...
{
    return mavlink_msg_esc_status_pack(system_id, component_id, msg, (uint8_t )(esc_status->index), (uint64_t )(esc_status->time_usec), (const int32_t *)(esc_status->rpm), (const float *)(esc_status->voltage), (const float *)(esc_status->current));
}
...
{
    return mavlink_msg_esc_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(esc_status->index), (uint64_t )(esc_status->time_usec), (const int32_t *)(esc_status->rpm), (const float *)(esc_status->voltage), (const float *)(esc_status->current));
}
