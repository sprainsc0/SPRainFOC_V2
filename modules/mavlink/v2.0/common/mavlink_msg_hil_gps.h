...
{
    return mavlink_msg_hil_gps_pack(system_id, component_id, msg, (uint64_t )(hil_gps->time_usec), (uint8_t )(hil_gps->fix_type), (int32_t )(hil_gps->lat), (int32_t )(hil_gps->lon), (int32_t )(hil_gps->alt), (uint16_t )(hil_gps->eph), (uint16_t )(hil_gps->epv), (uint16_t )(hil_gps->vel), (int16_t )(hil_gps->vn), (int16_t )(hil_gps->ve), (int16_t )(hil_gps->vd), (uint16_t )(hil_gps->cog), (uint8_t )(hil_gps->satellites_visible), (uint8_t )(hil_gps->id), (uint16_t )(hil_gps->yaw));
}
...
{
    return mavlink_msg_hil_gps_pack_chan(system_id, component_id, chan, msg, (uint64_t )(hil_gps->time_usec), (uint8_t )(hil_gps->fix_type), (int32_t )(hil_gps->lat), (int32_t )(hil_gps->lon), (int32_t )(hil_gps->alt), (uint16_t )(hil_gps->eph), (uint16_t )(hil_gps->epv), (uint16_t )(hil_gps->vel), (int16_t )(hil_gps->vn), (int16_t )(hil_gps->ve), (int16_t )(hil_gps->vd), (uint16_t )(hil_gps->cog), (uint8_t )(hil_gps->satellites_visible), (uint8_t )(hil_gps->id), (uint16_t )(hil_gps->yaw));
}
