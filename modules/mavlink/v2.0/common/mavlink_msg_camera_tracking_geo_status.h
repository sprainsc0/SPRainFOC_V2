...
{
    return mavlink_msg_camera_tracking_geo_status_pack(system_id, component_id, msg, (uint8_t )(camera_tracking_geo_status->tracking_status), (int32_t )(camera_tracking_geo_status->lat), (int32_t )(camera_tracking_geo_status->lon), (float )(camera_tracking_geo_status->alt), (float )(camera_tracking_geo_status->h_acc), (float )(camera_tracking_geo_status->v_acc), (float )(camera_tracking_geo_status->vel_n), (float )(camera_tracking_geo_status->vel_e), (float )(camera_tracking_geo_status->vel_d), (float )(camera_tracking_geo_status->vel_acc), (float )(camera_tracking_geo_status->dist), (float )(camera_tracking_geo_status->hdg), (float )(camera_tracking_geo_status->hdg_acc));
}
...
{
    return mavlink_msg_camera_tracking_geo_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(camera_tracking_geo_status->tracking_status), (int32_t )(camera_tracking_geo_status->lat), (int32_t )(camera_tracking_geo_status->lon), (float )(camera_tracking_geo_status->alt), (float )(camera_tracking_geo_status->h_acc), (float )(camera_tracking_geo_status->v_acc), (float )(camera_tracking_geo_status->vel_n), (float )(camera_tracking_geo_status->vel_e), (float )(camera_tracking_geo_status->vel_d), (float )(camera_tracking_geo_status->vel_acc), (float )(camera_tracking_geo_status->dist), (float )(camera_tracking_geo_status->hdg), (float )(camera_tracking_geo_status->hdg_acc));
}
