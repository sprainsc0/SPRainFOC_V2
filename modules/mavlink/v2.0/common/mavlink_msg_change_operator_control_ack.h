...
{
    return mavlink_msg_change_operator_control_ack_pack(system_id, component_id, msg, (uint8_t )(change_operator_control_ack->gcs_system_id), (uint8_t )(change_operator_control_ack->control_request), (uint8_t )(change_operator_control_ack->ack));
}
...
{
    return mavlink_msg_change_operator_control_ack_pack_chan(system_id, component_id, chan, msg, (uint8_t )(change_operator_control_ack->gcs_system_id), (uint8_t )(change_operator_control_ack->control_request), (uint8_t )(change_operator_control_ack->ack));
}
