...
{
    return mavlink_msg_named_value_float_pack(system_id, component_id, msg, (uint32_t )(named_value_float->time_boot_ms), (const char *)(named_value_float->name), (float )(named_value_float->value));
}
...
{
    return mavlink_msg_named_value_float_pack_chan(system_id, component_id, chan, msg, (uint32_t )(named_value_float->time_boot_ms), (const char *)(named_value_float->name), (float )(named_value_float->value));
}
