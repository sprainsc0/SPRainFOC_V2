...
{
    return mavlink_msg_position_target_local_ned_pack(system_id, component_id, msg, (uint32_t )(position_target_local_ned->time_boot_ms), (uint8_t )(position_target_local_ned->coordinate_frame), (uint16_t )(position_target_local_ned->type_mask), (float )(position_target_local_ned->x), (float )(position_target_local_ned->y), (float )(position_target_local_ned->z), (float )(position_target_local_ned->vx), (float )(position_target_local_ned->vy), (float )(position_target_local_ned->vz), (float )(position_target_local_ned->afx), (float )(position_target_local_ned->afy), (float )(position_target_local_ned->afz), (float )(position_target_local_ned->yaw), (float )(position_target_local_ned->yaw_rate));
}
...
{
    return mavlink_msg_position_target_local_ned_pack_chan(system_id, component_id, chan, msg, (uint32_t )(position_target_local_ned->time_boot_ms), (uint8_t )(position_target_local_ned->coordinate_frame), (uint16_t )(position_target_local_ned->type_mask), (float )(position_target_local_ned->x), (float )(position_target_local_ned->y), (float )(position_target_local_ned->z), (float )(position_target_local_ned->vx), (float )(position_target_local_ned->vy), (float )(position_target_local_ned->vz), (float )(position_target_local_ned->afx), (float )(position_target_local_ned->afy), (float )(position_target_local_ned->afz), (float )(position_target_local_ned->yaw), (float )(position_target_local_ned->yaw_rate));
}
