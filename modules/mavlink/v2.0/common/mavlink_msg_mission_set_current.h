...
{
    return mavlink_msg_mission_set_current_pack(system_id, component_id, msg, (uint8_t )(mission_set_current->target_system), (uint8_t )(mission_set_current->target_component), (uint16_t )(mission_set_current->seq));
}
...
{
    return mavlink_msg_mission_set_current_pack_chan(system_id, component_id, chan, msg, (uint8_t )(mission_set_current->target_system), (uint8_t )(mission_set_current->target_component), (uint16_t )(mission_set_current->seq));
}
