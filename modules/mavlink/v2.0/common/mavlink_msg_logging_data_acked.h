...
{
    return mavlink_msg_logging_data_acked_pack(system_id, component_id, msg, (uint8_t )(logging_data_acked->target_system), (uint8_t )(logging_data_acked->target_component), (uint16_t )(logging_data_acked->sequence), (uint8_t )(logging_data_acked->length), (uint8_t )(logging_data_acked->first_message_offset), (const uint8_t *)(logging_data_acked->data));
}
...
{
    return mavlink_msg_logging_data_acked_pack_chan(system_id, component_id, chan, msg, (uint8_t )(logging_data_acked->target_system), (uint8_t )(logging_data_acked->target_component), (uint16_t )(logging_data_acked->sequence), (uint8_t )(logging_data_acked->length), (uint8_t )(logging_data_acked->first_message_offset), (const uint8_t *)(logging_data_acked->data));
}
