...
{
    return mavlink_msg_named_value_int_pack(system_id, component_id, msg, (uint32_t )(named_value_int->time_boot_ms), (const char *)(named_value_int->name), (int32_t )(named_value_int->value));
}
...
{
    return mavlink_msg_named_value_int_pack_chan(system_id, component_id, chan, msg, (uint32_t )(named_value_int->time_boot_ms), (const char *)(named_value_int->name), (int32_t )(named_value_int->value));
}
