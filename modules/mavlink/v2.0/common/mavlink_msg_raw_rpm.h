...
{
    return mavlink_msg_raw_rpm_pack(system_id, component_id, msg, (uint8_t )(raw_rpm->index), (float )(raw_rpm->frequency));
}
...
{
    return mavlink_msg_raw_rpm_pack_chan(system_id, component_id, chan, msg, (uint8_t )(raw_rpm->index), (float )(raw_rpm->frequency));
}
