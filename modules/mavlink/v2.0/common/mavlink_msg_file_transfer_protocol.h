...
{
    return mavlink_msg_file_transfer_protocol_pack(system_id, component_id, msg, (uint8_t )(file_transfer_protocol->target_network), (uint8_t )(file_transfer_protocol->target_system), (uint8_t )(file_transfer_protocol->target_component), (const uint8_t *)(file_transfer_protocol->payload));
}
...
{
    return mavlink_msg_file_transfer_protocol_pack_chan(system_id, component_id, chan, msg, (uint8_t )(file_transfer_protocol->target_network), (uint8_t )(file_transfer_protocol->target_system), (uint8_t )(file_transfer_protocol->target_component), (const uint8_t *)(file_transfer_protocol->payload));
}
