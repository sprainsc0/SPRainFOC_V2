...
{
    return mavlink_msg_command_cancel_pack(system_id, component_id, msg, (uint8_t )(command_cancel->target_system), (uint8_t )(command_cancel->target_component), (uint16_t )(command_cancel->command));
}
...
{
    return mavlink_msg_command_cancel_pack_chan(system_id, component_id, chan, msg, (uint8_t )(command_cancel->target_system), (uint8_t )(command_cancel->target_component), (uint16_t )(command_cancel->command));
}
