...
{
    return mavlink_msg_orbit_execution_status_pack(system_id, component_id, msg, (uint64_t )(orbit_execution_status->time_usec), (float )(orbit_execution_status->radius), (uint8_t )(orbit_execution_status->frame), (int32_t )(orbit_execution_status->x), (int32_t )(orbit_execution_status->y), (float )(orbit_execution_status->z));
}
...
{
    return mavlink_msg_orbit_execution_status_pack_chan(system_id, component_id, chan, msg, (uint64_t )(orbit_execution_status->time_usec), (float )(orbit_execution_status->radius), (uint8_t )(orbit_execution_status->frame), (int32_t )(orbit_execution_status->x), (int32_t )(orbit_execution_status->y), (float )(orbit_execution_status->z));
}
