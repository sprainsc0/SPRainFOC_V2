...
{
    return mavlink_msg_camera_tracking_image_status_pack(system_id, component_id, msg, (uint8_t )(camera_tracking_image_status->tracking_status), (uint8_t )(camera_tracking_image_status->tracking_mode), (uint8_t )(camera_tracking_image_status->target_data), (float )(camera_tracking_image_status->point_x), (float )(camera_tracking_image_status->point_y), (float )(camera_tracking_image_status->radius), (float )(camera_tracking_image_status->rec_top_x), (float )(camera_tracking_image_status->rec_top_y), (float )(camera_tracking_image_status->rec_bottom_x), (float )(camera_tracking_image_status->rec_bottom_y));
}
...
{
    return mavlink_msg_camera_tracking_image_status_pack_chan(system_id, component_id, chan, msg, (uint8_t )(camera_tracking_image_status->tracking_status), (uint8_t )(camera_tracking_image_status->tracking_mode), (uint8_t )(camera_tracking_image_status->target_data), (float )(camera_tracking_image_status->point_x), (float )(camera_tracking_image_status->point_y), (float )(camera_tracking_image_status->radius), (float )(camera_tracking_image_status->rec_top_x), (float )(camera_tracking_image_status->rec_top_y), (float )(camera_tracking_image_status->rec_bottom_x), (float )(camera_tracking_image_status->rec_bottom_y));
}
