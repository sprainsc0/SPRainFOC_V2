...
{
    return mavlink_msg_statustext_pack(system_id, component_id, msg, (uint8_t )(statustext->severity), (const char *)(statustext->text), (uint16_t )(statustext->id), (uint8_t )(statustext->chunk_seq));
}
...
{
    return mavlink_msg_statustext_pack_chan(system_id, component_id, chan, msg, (uint8_t )(statustext->severity), (const char *)(statustext->text), (uint16_t )(statustext->id), (uint8_t )(statustext->chunk_seq));
}
