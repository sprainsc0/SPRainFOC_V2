...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, (uint8_t )(heartbeat->type), (uint8_t )(heartbeat->autopilot), (uint8_t )(heartbeat->base_mode), (uint32_t )(heartbeat->custom_mode), (uint8_t )(heartbeat->system_status));
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, (uint8_t )(heartbeat->type), (uint8_t )(heartbeat->autopilot), (uint8_t )(heartbeat->base_mode), (uint32_t )(heartbeat->custom_mode), (uint8_t )(heartbeat->system_status));
}
