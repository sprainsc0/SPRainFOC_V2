...
{
    return mavlink_msg_protocol_version_pack(system_id, component_id, msg, (uint16_t )(protocol_version->version), (uint16_t )(protocol_version->min_version), (uint16_t )(protocol_version->max_version), (const uint8_t *)(protocol_version->spec_version_hash), (const uint8_t *)(protocol_version->library_version_hash));
}
...
{
    return mavlink_msg_protocol_version_pack_chan(system_id, component_id, chan, msg, (uint16_t )(protocol_version->version), (uint16_t )(protocol_version->min_version), (uint16_t )(protocol_version->max_version), (const uint8_t *)(protocol_version->spec_version_hash), (const uint8_t *)(protocol_version->library_version_hash));
}
