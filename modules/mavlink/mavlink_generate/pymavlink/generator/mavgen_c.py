...
{
    return mavlink_msg_${name_lower}_pack(system_id, component_id, msg,${{arg_fields: (${array_const}${type} ${array_prefix})(${name_lower}->${name}),}});
}
...
{
    return mavlink_msg_${name_lower}_pack_chan(system_id, component_id, chan, msg,${{arg_fields: (${array_const}${type} ${array_prefix})(${name_lower}->${name}),}});
}
